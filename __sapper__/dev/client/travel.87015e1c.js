...
import { T as Truman } from './Truman.81eff88f.js';
...
// (58:0) {#each photosOne as photo, i}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 59, 11, 1243);
			add_location(figure, file$2, 59, 3, 1235);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 58, 1, 1194);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(58:0) {#each photosOne as photo, i}",
		ctx
	});
...
// (66:0) {#each photosTwo as photo, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-2ikc7i");
			add_location(img, file$2, 67, 11, 1405);
			add_location(figure, file$2, 67, 3, 1397);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 66, 1, 1356);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(66:0) {#each photosTwo as photo, i}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 44, 6, 1018);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 43, 4, 988);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 42, 2, 960);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-2ikc7i");
			add_location(section, file$2, 38, 0, 869);
			add_location(p, file$2, 51, 1, 1130);
			attr_dev(div2, "class", "container");
			add_location(div2, file$2, 50, 0, 1105);
		},
		m: function mount(target, anchor) {
