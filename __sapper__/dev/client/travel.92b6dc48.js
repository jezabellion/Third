...
import { T as Truman } from './Truman.a50b5290.js';
...
// (55:0) {#each photosOne as photo, i}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 56, 11, 1292);
			add_location(figure, file$2, 56, 3, 1284);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 55, 1, 1243);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(55:0) {#each photosOne as photo, i}",
		ctx
	});
...
// (63:0) {#each photosTwo as photo, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[4].alt);
			attr_dev(img, "class", "svelte-2ikc7i");
			add_location(img, file$2, 64, 11, 1454);
			add_location(figure, file$2, 64, 3, 1446);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 63, 1, 1405);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(63:0) {#each photosTwo as photo, i}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 47, 6, 1116);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 46, 4, 1086);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 45, 2, 1058);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-2ikc7i");
			add_location(section, file$2, 41, 0, 967);
		},
		m: function mount(target, anchor) {
