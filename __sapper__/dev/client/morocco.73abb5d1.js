import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, b as children, f as detach_dev, g as claim_space, h as claim_text, j as attr_dev, k as add_location, m as insert_dev, n as append_dev, p as noop, C as identity, u as create_component, w as claim_component, x as mount_component, D as set_data_dev, z as transition_in, E as add_render_callback, F as create_in_transition, A as transition_out, B as destroy_component, G as validate_each_argument, H as empty, I as query_selector_all, J as destroy_each } from './client.d98b8bd6.js';
import { d as destination, b as blurb, c as chapter, p as photosOne, a as photosTwo } from './morocco.348cdf80.js';
import { C as ChapterHeader } from './ChapterHeader.8207f4d6.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a2, file, 32, 10, 1378);
			attr_dev(a3, "class", "navbar-item");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 33, 10, 1448);
			attr_dev(a4, "class", "navbar-item");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 34, 10, 1519);
			attr_dev(a5, "class", "navbar-item");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 35, 10, 1588);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 31, 8, 1337);
			attr_dev(div2, "class", "navbar-item");
			add_location(div2, file, 30, 6, 1303);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile is-link");
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1p6oif7");
			add_location(h1, file$1, 34, 6, 901);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 33, 4, 871);
			attr_dev(div1, "class", "hero-body svelte-1p6oif7");
			add_location(div1, file$1, 32, 2, 843);
			attr_dev(section, "class", "hero is-fullheight svelte-1p6oif7");
			add_location(section, file$1, 28, 0, 753);
		},
		m: function mount(target, anchor) {
