...
import { M as ModalNav } from './ModalNav.f80be4cb.js';
import { C as ChapterHeader } from './ChapterHeader.6bc088a5.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1176b73");
			add_location(h1, file$3, 93, 8, 1936);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 92, 6, 1904);
			attr_dev(div1, "class", "shoes hero-body svelte-1176b73");
			add_location(div1, file$3, 91, 4, 1868);
			attr_dev(div2, "class", "hero-image svelte-1176b73");
			add_location(div2, file$3, 90, 2, 1839);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1176b73");
			add_location(a0, file$3, 104, 14, 2233);
			add_location(li0, file$3, 104, 10, 2229);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1176b73");
			add_location(a1, file$3, 105, 14, 2292);
			add_location(li1, file$3, 105, 10, 2288);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1176b73");
			add_location(a2, file$3, 106, 14, 2350);
			add_location(li2, file$3, 106, 10, 2346);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1176b73");
			add_location(a3, file$3, 107, 14, 2410);
			add_location(li3, file$3, 107, 10, 2406);
			attr_dev(ul, "class", "svelte-1176b73");
			add_location(ul, file$3, 102, 8, 2156);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 101, 6, 2124);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1176b73");
			add_location(nav, file$3, 100, 4, 2086);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1176b73");
			add_location(div4, file$3, 99, 2, 2041);
			attr_dev(button, "class", "button is-white svelte-1176b73");
			add_location(button, file$3, 116, 4, 2609);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 115, 2, 2566);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 114, 0, 2523);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
