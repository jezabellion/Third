import { y as identity, S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, B as Bonkers, v as validate_slots, a as space, e as element, o as create_component, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, p as claim_component, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, r as mount_component, m as append_dev, u as transition_in, z as add_render_callback, A as create_in_transition, w as transition_out, x as destroy_component } from './client.00c31061.js';
import { T as Truman } from './Truman.bdbdda94.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 63, 6, 1243);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 62, 4, 1213);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file, 61, 2, 1185);
			...
			add_location(p0, file, 69, 2, 1361);
			attr_dev(p1, "class", "svelte-1abxzzq");
			add_location(p1, file, 70, 2, 1483);
			attr_dev(p2, "class", "svelte-1abxzzq");
			add_location(p2, file, 71, 2, 1498);
			attr_dev(div2, "class", "container blurb svelte-1abxzzq");
			add_location(div2, file, 68, 0, 1329);
			...
			add_location(img0, file, 75, 10, 1577);
			add_location(figure0, file, 75, 2, 1569);
			attr_dev(div3, "class", "container image-gallery svelte-1abxzzq");
			add_location(div3, file, 74, 0, 1529);
			attr_dev(h2, "class", "svelte-1abxzzq");
			add_location(h2, file, 80, 4, 1699);
			attr_dev(p3, "class", "svelte-1abxzzq");
			add_location(p3, file, 81, 4, 1726);
			attr_dev(div4, "class", "chapter-header svelte-1abxzzq");
			add_location(div4, file, 79, 2, 1666);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 78, 0, 1640);
			...
			add_location(img1, file, 86, 10, 1804);
			add_location(figure1, file, 86, 2, 1796);
			...
			add_location(img2, file, 87, 10, 1869);
			add_location(figure2, file, 87, 2, 1861);
			...
			add_location(img3, file, 88, 10, 1934);
			add_location(figure3, file, 88, 2, 1926);
			...
			add_location(img4, file, 89, 10, 1999);
			add_location(figure4, file, 89, 2, 1991);
			attr_dev(div6, "class", "container image-gallery svelte-1abxzzq");
			add_location(div6, file, 85, 0, 1756);
		},
