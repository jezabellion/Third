...
import { M as ModalNav } from './ModalNav.c13e855d.js';
import { C as ChapterHeader } from './ChapterHeader.49b8611b.js';
...
function create_fragment$3(ctx) {
	...
	let li0;
	let a0;
	let t2_value = destination.one + "";
	let t2;
	let t3;
	let li1;
	let a1;
	let t4_value = destination.two + "";
	let t4;
	let t5;
	let li2;
	let a2;
	let t6_value = destination.three + "";
	let t6;
	let t7;
	let li3;
	let a3;
	let t8_value = destination.four + "";
	let t8;
	let t9;
	let div5;
	let button;
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			h1 = claim_element(div0_nodes, "H1", { class: true });
			var h1_nodes = children(h1);
			t0 = claim_text(h1_nodes, "Wanderlust");
			h1_nodes.forEach(detach_dev);
			div0_nodes.forEach(detach_dev);
			div1_nodes.forEach(detach_dev);
			div2_nodes.forEach(detach_dev);
			...
			t10 = claim_text(button_nodes, "Whatever");
			button_nodes.forEach(detach_dev);
			div5_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1uftri7");
			add_location(h1, file$3, 121, 8, 2732);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 120, 6, 2700);
			attr_dev(div1, "class", "shoes hero-body svelte-1uftri7");
			add_location(div1, file$3, 119, 4, 2664);
			attr_dev(div2, "class", "hero-image svelte-1uftri7");
			add_location(div2, file$3, 118, 2, 2635);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1uftri7");
			add_location(a0, file$3, 132, 14, 3029);
			add_location(li0, file$3, 132, 10, 3025);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1uftri7");
			add_location(a1, file$3, 133, 14, 3088);
			add_location(li1, file$3, 133, 10, 3084);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1uftri7");
			add_location(a2, file$3, 134, 14, 3146);
			add_location(li2, file$3, 134, 10, 3142);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1uftri7");
			add_location(a3, file$3, 135, 14, 3206);
			add_location(li3, file$3, 135, 10, 3202);
			attr_dev(ul, "class", "svelte-1uftri7");
			add_location(ul, file$3, 130, 8, 2952);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 129, 6, 2920);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1uftri7");
			add_location(nav, file$3, 128, 4, 2882);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1uftri7");
			add_location(div4, file$3, 127, 2, 2837);
			add_location(button, file$3, 143, 2, 3364);
			attr_dev(div5, "class", "is-hidden-tablet is-centered");
			add_location(div5, file$3, 142, 0, 3319);
		},
		m: function mount(target, anchor, remount) {
