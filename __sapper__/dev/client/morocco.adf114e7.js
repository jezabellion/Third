...
import { M as ModalNav, d as destination } from './ModalNav.a166fe62.js';
import { c as copy, b as backgroundHero, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.a461e82b.js';
			...
			if (dirty & /*photos*/ 0) {
				...
				for (i = 0; i < each_value_7.length; i += 1) {
					...
					if (each_blocks_7[i]) {
						...
						each_blocks_7[i].c();
						each_blocks_7[i].m(t3.parentNode, t3);
					}
				}
			...
			if (dirty & /*photos*/ 0) {
				...
				for (i = 0; i < each_value_6.length; i += 1) {
					...
					if (each_blocks_6[i]) {
						...
						each_blocks_6[i].c();
						each_blocks_6[i].m(t5.parentNode, t5);
					}
				}
			...
			if (dirty & /*photos*/ 0) {
				...
				for (i = 0; i < each_value_2.length; i += 1) {
					...
					if (each_blocks_2[i]) {
						...
						each_blocks_2[i].c();
						each_blocks_2[i].m(t13.parentNode, t13);
					}
				}
