import { y as identity, S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, B as Bonkers, v as validate_slots, a as space, e as element, o as create_component, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, p as claim_component, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, r as mount_component, m as append_dev, u as transition_in, z as add_render_callback, A as create_in_transition, w as transition_out, x as destroy_component } from './client.b440f833.js';
import { T as Truman } from './Truman.d5a0727d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file, 77, 10, 1686);
			add_location(figure0, file, 77, 2, 1678);
			...
			add_location(h2, file, 82, 4, 1797);
			attr_dev(p3, "class", "svelte-1abxzzq");
			add_location(p3, file, 83, 4, 1824);
			attr_dev(div4, "class", "chapter-header svelte-1abxzzq");
			add_location(div4, file, 81, 2, 1764);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 80, 0, 1738);
			...
			add_location(img1, file, 88, 10, 1902);
			add_location(figure1, file, 88, 2, 1894);
			...
			add_location(img2, file, 89, 10, 1967);
			add_location(figure2, file, 89, 2, 1959);
			...
			add_location(img3, file, 90, 10, 2032);
			add_location(figure3, file, 90, 2, 2024);
			...
			add_location(img4, file, 91, 10, 2097);
			add_location(figure4, file, 91, 2, 2089);
			attr_dev(div6, "class", "container image-gallery svelte-1abxzzq");
			add_location(div6, file, 87, 0, 1854);
		},
