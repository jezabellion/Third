...
import { M as ModalNav } from './ModalNav.b32bb6cd.js';
import { C as ChapterHeader } from './ChapterHeader.bb30e8d8.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-wvxtyo");
			add_location(h1, file$3, 114, 8, 2621);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 113, 6, 2589);
			attr_dev(div1, "class", "shoes hero-body svelte-wvxtyo");
			add_location(div1, file$3, 112, 4, 2553);
			attr_dev(div2, "class", "hero-image svelte-wvxtyo");
			add_location(div2, file$3, 111, 2, 2524);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-wvxtyo");
			add_location(a0, file$3, 125, 14, 2918);
			add_location(li0, file$3, 125, 10, 2914);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-wvxtyo");
			add_location(a1, file$3, 126, 14, 2977);
			add_location(li1, file$3, 126, 10, 2973);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-wvxtyo");
			add_location(a2, file$3, 127, 14, 3035);
			add_location(li2, file$3, 127, 10, 3031);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-wvxtyo");
			add_location(a3, file$3, 128, 14, 3095);
			add_location(li3, file$3, 128, 10, 3091);
			attr_dev(ul, "class", "svelte-wvxtyo");
			add_location(ul, file$3, 123, 8, 2841);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 122, 6, 2809);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-wvxtyo");
			add_location(nav, file$3, 121, 4, 2771);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-wvxtyo");
			add_location(div4, file$3, 120, 2, 2726);
		},
		m: function mount(target, anchor) {
