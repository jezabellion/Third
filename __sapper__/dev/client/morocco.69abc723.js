...
import { M as ModalNav } from './ModalNav.57ff038b.js';
import { C as ChapterHeader } from './ChapterHeader.f5a76fca.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 50, 12, 1298);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 50, 4, 1290);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 49, 2, 1248);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
