...
import { M as ModalNav } from './ModalNav.24374cbe.js';
import { C as ChapterHeader } from './ChapterHeader.1599294e.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 33, 12, 878);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$3, 33, 4, 870);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$3, 32, 2, 828);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$3, 41, 12, 1065);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$3, 41, 4, 1057);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$3, 40, 2, 1015);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$3, 49, 12, 1252);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$3, 49, 4, 1244);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$3, 48, 2, 1202);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
