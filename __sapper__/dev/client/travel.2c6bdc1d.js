...
import { T as Truman } from './Truman.482b7ef3.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$2, 24, 4, 562);
