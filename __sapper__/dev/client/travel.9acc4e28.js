import { y as identity, S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, B as Bonkers, v as validate_slots, a as space, e as element, o as create_component, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, p as claim_component, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, r as mount_component, m as append_dev, u as transition_in, z as add_render_callback, A as create_in_transition, w as transition_out, x as destroy_component } from './client.b2203cd0.js';
import { T as Truman } from './Truman.83001d38.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 65, 6, 1340);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 64, 4, 1310);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file, 63, 2, 1282);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-1abxzzq");
			add_location(section, file, 59, 0, 1192);
			attr_dev(p0, "class", "svelte-1abxzzq");
			add_location(p0, file, 71, 2, 1458);
			attr_dev(p1, "class", "svelte-1abxzzq");
			add_location(p1, file, 72, 2, 1580);
			attr_dev(p2, "class", "svelte-1abxzzq");
			add_location(p2, file, 73, 2, 1595);
			attr_dev(div2, "class", "container blurb svelte-1abxzzq");
			add_location(div2, file, 70, 0, 1426);
			...
			add_location(img0, file, 77, 10, 1674);
			add_location(figure0, file, 77, 2, 1666);
			attr_dev(div3, "class", "container image-gallery svelte-1abxzzq");
			add_location(div3, file, 76, 0, 1626);
			attr_dev(h2, "class", "svelte-1abxzzq");
			add_location(h2, file, 82, 4, 1796);
			attr_dev(p3, "class", "svelte-1abxzzq");
			add_location(p3, file, 83, 4, 1823);
			attr_dev(div4, "class", "chapter-header svelte-1abxzzq");
			add_location(div4, file, 81, 2, 1763);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 80, 0, 1737);
			...
			add_location(img1, file, 88, 10, 1901);
			add_location(figure1, file, 88, 2, 1893);
			...
			add_location(img2, file, 89, 10, 1966);
			add_location(figure2, file, 89, 2, 1958);
			...
			add_location(img3, file, 90, 10, 2031);
			add_location(figure3, file, 90, 2, 2023);
			...
			add_location(img4, file, 91, 10, 2096);
			add_location(figure4, file, 91, 2, 2088);
			attr_dev(div6, "class", "container image-gallery svelte-1abxzzq");
			add_location(div6, file, 87, 0, 1853);
		},
