...
import { T as Truman } from './Truman.31a3dc8e.js';
...
// (62:0) {#each photosOne as photo, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 63, 11, 1470);
			add_location(figure, file$2, 63, 3, 1462);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 62, 1, 1421);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(62:0) {#each photosOne as photo, i}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	let each_value = /*photosOne*/ ctx[1];
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			figure3 = claim_element(div2_nodes, "FIGURE", {});
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 54, 6, 1294);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 53, 4, 1264);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 52, 2, 1236);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-2ikc7i");
			add_location(section, file$2, 48, 0, 1145);
			attr_dev(img0, "alt", "handsome man");
			if (img0.src !== (img0_src_value = "images/aaa.jpg")) attr_dev(img0, "src", img0_src_value);
			attr_dev(img0, "class", "svelte-2ikc7i");
			add_location(img0, file$2, 70, 10, 1600);
			add_location(figure0, file$2, 70, 2, 1592);
			attr_dev(img1, "alt", "handsome man");
			if (img1.src !== (img1_src_value = "images/bbb.jpg")) attr_dev(img1, "src", img1_src_value);
			attr_dev(img1, "class", "svelte-2ikc7i");
			add_location(img1, file$2, 71, 10, 1665);
			add_location(figure1, file$2, 71, 2, 1657);
			attr_dev(img2, "alt", "handsome man");
			if (img2.src !== (img2_src_value = "images/ccc.jpg")) attr_dev(img2, "src", img2_src_value);
			attr_dev(img2, "class", "svelte-2ikc7i");
			add_location(img2, file$2, 72, 10, 1730);
			add_location(figure2, file$2, 72, 2, 1722);
			attr_dev(img3, "alt", "handsome man");
			if (img3.src !== (img3_src_value = "images/ddd.jpg")) attr_dev(img3, "src", img3_src_value);
			attr_dev(img3, "class", "svelte-2ikc7i");
			add_location(img3, file$2, 73, 10, 1795);
			add_location(figure3, file$2, 73, 2, 1787);
			attr_dev(div2, "class", "container image-gallery svelte-2ikc7i");
			add_location(div2, file$2, 69, 0, 1552);
		},
		m: function mount(target, anchor) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ("photosTwo" in $$props) photosTwo = $$props.photosTwo;
	};
