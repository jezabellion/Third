...
import { M as ModalNav } from './ModalNav.a2e73e7b.js';
import { C as ChapterHeader } from './ChapterHeader.6a9e90f6.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 26, 8, 645);
			attr_dev(a0, "class", "navbar-item svelte-1htvo2w");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 25, 6, 603);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-1htvo2w");
			add_location(span0, file, 29, 8, 877);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-1htvo2w");
			add_location(span1, file, 30, 8, 918);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-1htvo2w");
			add_location(span2, file, 31, 8, 959);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-1htvo2w");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 28, 6, 738);
			attr_dev(div0, "class", "navbar-brand svelte-1htvo2w");
			add_location(div0, file, 24, 4, 570);
			attr_dev(a2, "class", "navbar-item svelte-1htvo2w");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 38, 10, 1142);
			attr_dev(a3, "class", "navbar-item svelte-1htvo2w");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 39, 10, 1212);
			attr_dev(a4, "class", "navbar-item svelte-1htvo2w");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 40, 10, 1283);
			attr_dev(a5, "class", "navbar-item svelte-1htvo2w");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 41, 10, 1352);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 37, 8, 1101);
			attr_dev(div2, "class", "navbar-item svelte-1htvo2w");
			add_location(div2, file, 36, 6, 1067);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 35, 4, 1019);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 23, 2, 520);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 22, 0, 494);
		},
