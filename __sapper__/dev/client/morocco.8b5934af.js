...
import { M as ModalNav } from './ModalNav.9b773f95.js';
import { C as ChapterHeader } from './ChapterHeader.3a3aebfa.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-cyz57h");
			add_location(h1, file$3, 122, 8, 2731);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 121, 6, 2699);
			attr_dev(div1, "class", "shoes hero-body svelte-cyz57h");
			add_location(div1, file$3, 120, 4, 2663);
			attr_dev(div2, "class", "hero-image svelte-cyz57h");
			add_location(div2, file$3, 119, 2, 2634);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-cyz57h");
			add_location(a0, file$3, 133, 14, 3028);
			add_location(li0, file$3, 133, 10, 3024);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-cyz57h");
			add_location(a1, file$3, 134, 14, 3087);
			add_location(li1, file$3, 134, 10, 3083);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-cyz57h");
			add_location(a2, file$3, 135, 14, 3145);
			add_location(li2, file$3, 135, 10, 3141);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-cyz57h");
			add_location(a3, file$3, 136, 14, 3205);
			add_location(li3, file$3, 136, 10, 3201);
			attr_dev(ul, "class", "svelte-cyz57h");
			add_location(ul, file$3, 131, 8, 2951);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 130, 6, 2919);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-cyz57h");
			add_location(nav, file$3, 129, 4, 2881);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-cyz57h");
			add_location(div4, file$3, 128, 2, 2836);
			attr_dev(button, "class", "button is-white svelte-cyz57h");
			add_location(button, file$3, 145, 2, 3401);
			attr_dev(div5, "class", "column has-text-centered\t");
			add_location(div5, file$3, 144, 0, 3359);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 143, 0, 3318);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
