...
import { M as ModalNav } from './ModalNav.f809ef40.js';
import { C as ChapterHeader } from './ChapterHeader.e0e5e799.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-ou2pb4");
			add_location(h1, file$3, 101, 8, 2087);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 100, 6, 2055);
			attr_dev(div1, "class", "shoes hero-body svelte-ou2pb4");
			add_location(div1, file$3, 99, 4, 2019);
			attr_dev(div2, "class", "hero-image svelte-ou2pb4");
			add_location(div2, file$3, 98, 2, 1990);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-ou2pb4");
			add_location(a0, file$3, 112, 14, 2384);
			add_location(li0, file$3, 112, 10, 2380);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-ou2pb4");
			add_location(a1, file$3, 113, 14, 2443);
			add_location(li1, file$3, 113, 10, 2439);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-ou2pb4");
			add_location(a2, file$3, 114, 14, 2501);
			add_location(li2, file$3, 114, 10, 2497);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-ou2pb4");
			add_location(a3, file$3, 115, 14, 2561);
			add_location(li3, file$3, 115, 10, 2557);
			attr_dev(ul, "class", "svelte-ou2pb4");
			add_location(ul, file$3, 110, 8, 2307);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 109, 6, 2275);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-ou2pb4");
			add_location(nav, file$3, 108, 4, 2237);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-ou2pb4");
			add_location(div4, file$3, 107, 2, 2192);
			attr_dev(button, "class", "button is-white svelte-ou2pb4");
			add_location(button, file$3, 124, 4, 2760);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 123, 2, 2717);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 122, 0, 2674);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
