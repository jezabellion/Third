...
import { T as Truman } from './Truman.b46f5aca.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 64, 11, 1425);
			add_location(figure, file$2, 64, 3, 1417);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 63, 1, 1376);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[4].alt);
			attr_dev(img, "class", "svelte-2ikc7i");
			add_location(img, file$2, 72, 11, 1587);
			add_location(figure, file$2, 72, 3, 1579);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 71, 1, 1538);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 49, 6, 1200);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 48, 4, 1170);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 47, 2, 1142);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-2ikc7i");
			add_location(section, file$2, 43, 0, 1051);
			add_location(p, file$2, 56, 1, 1312);
			attr_dev(div2, "class", "container");
			add_location(div2, file$2, 55, 0, 1287);
		},
		m: function mount(target, anchor) {
