...
import { M as ModalNav } from './ModalNav.0148ec13.js';
import { C as ChapterHeader } from './ChapterHeader.00b45847.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-vxwizo");
			add_location(h1, file$3, 92, 8, 1887);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 91, 6, 1855);
			attr_dev(div1, "class", "shoes hero-body svelte-vxwizo");
			add_location(div1, file$3, 90, 4, 1819);
			attr_dev(div2, "class", "hero-image svelte-vxwizo");
			add_location(div2, file$3, 89, 2, 1790);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-vxwizo");
			add_location(a0, file$3, 103, 14, 2184);
			add_location(li0, file$3, 103, 10, 2180);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-vxwizo");
			add_location(a1, file$3, 104, 14, 2243);
			add_location(li1, file$3, 104, 10, 2239);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-vxwizo");
			add_location(a2, file$3, 105, 14, 2301);
			add_location(li2, file$3, 105, 10, 2297);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-vxwizo");
			add_location(a3, file$3, 106, 14, 2361);
			add_location(li3, file$3, 106, 10, 2357);
			attr_dev(ul, "class", "svelte-vxwizo");
			add_location(ul, file$3, 101, 8, 2107);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 100, 6, 2075);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-vxwizo");
			add_location(nav, file$3, 99, 4, 2037);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-vxwizo");
			add_location(div4, file$3, 98, 2, 1992);
			attr_dev(button, "class", "button is-white svelte-vxwizo");
			add_location(button, file$3, 115, 4, 2560);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 114, 2, 2517);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 113, 0, 2474);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
