...
import { T as Truman } from './Truman.9885021c.js';
import { d as destination, C as ChapterHeader, c as chapter, p as photosOne, a as photosTwo, b as chapterOne, e as chapterTwo } from './ChapterHeader.0b1454a3.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$2, 42, 12, 999);
			add_location(figure, file$2, 42, 4, 991);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$2, 41, 2, 949);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$2, 50, 12, 1188);
			add_location(figure, file$2, 50, 4, 1180);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$2, 49, 2, 1138);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
