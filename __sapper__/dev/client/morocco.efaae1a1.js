...
import { M as ModalNav, d as destination } from './ModalNav.0e545b3a.js';
import { c as copy, b as backgroundHero, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.e1719580.js';
...
function create_each_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$4, 39, 12, 1031);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 39, 4, 1023);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 38, 2, 981);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 47, 12, 1219);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 47, 4, 1211);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 46, 2, 1169);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 55, 12, 1409);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 55, 4, 1401);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 54, 2, 1359);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 61, 12, 1560);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 61, 4, 1552);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 60, 2, 1510);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
class Morocco extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { preload: 0 });
