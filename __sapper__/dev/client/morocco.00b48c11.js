...
import { C as ChapterHeader } from './ChapterHeader.49ae6af1.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(p0_nodes, blurbCopy);
		...
		h: function hydrate() {
			...
			add_location(p0, file$2, 19, 2, 415);
			attr_dev(p1, "class", "svelte-1gn6av2");
			add_location(p1, file$2, 20, 2, 436);
			attr_dev(p2, "class", "svelte-1gn6av2");
			add_location(p2, file$2, 21, 2, 451);
			attr_dev(div, "class", "container blurb svelte-1gn6av2");
			add_location(div, file$2, 18, 0, 383);
		},
		m: function mount(target, anchor) {
