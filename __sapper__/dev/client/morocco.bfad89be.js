...
import { M as ModalNav } from './ModalNav.4d999ae1.js';
import { C as ChapterHeader } from './ChapterHeader.5862e6f9.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 114, 8, 2651);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 113, 6, 2619);
			attr_dev(div1, "class", "shoes hero-body svelte-phw0zu");
			add_location(div1, file$3, 112, 4, 2583);
			attr_dev(div2, "class", "hero-image svelte-phw0zu");
			add_location(div2, file$3, 111, 2, 2554);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-phw0zu");
			add_location(a0, file$3, 125, 14, 2948);
			add_location(li0, file$3, 125, 10, 2944);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-phw0zu");
			add_location(a1, file$3, 126, 14, 3007);
			add_location(li1, file$3, 126, 10, 3003);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-phw0zu");
			add_location(a2, file$3, 127, 14, 3065);
			add_location(li2, file$3, 127, 10, 3061);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-phw0zu");
			add_location(a3, file$3, 128, 14, 3125);
			add_location(li3, file$3, 128, 10, 3121);
			attr_dev(ul, "class", "svelte-phw0zu");
			add_location(ul, file$3, 123, 8, 2871);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 122, 6, 2839);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-phw0zu");
			add_location(nav, file$3, 121, 4, 2801);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-phw0zu");
			add_location(div4, file$3, 120, 2, 2756);
		},
		m: function mount(target, anchor) {
