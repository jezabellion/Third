...
import { M as ModalNav } from './ModalNav.1786e5da.js';
import { C as ChapterHeader } from './ChapterHeader.8047ee7e.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p0, "class", "svelte-14fqzk4");
			add_location(p0, file$2, 27, 2, 590);
			attr_dev(p1, "class", "svelte-14fqzk4");
			add_location(p1, file$2, 28, 2, 611);
			attr_dev(p2, "class", "svelte-14fqzk4");
			add_location(p2, file$2, 29, 2, 626);
			attr_dev(div, "class", "container blurb svelte-14fqzk4");
