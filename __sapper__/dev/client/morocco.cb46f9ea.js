...
import { C as ChapterHeader } from './ChapterHeader.826b6fb9.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-txxemu");
			add_location(img, file$3, 31, 12, 826);
			attr_dev(figure, "class", "svelte-txxemu");
			add_location(figure, file$3, 31, 4, 818);
			attr_dev(div, "class", "container image-gallery svelte-txxemu");
