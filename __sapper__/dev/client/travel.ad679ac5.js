import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, y as identity, B as Bonkers, o as create_component, q as query_selector_all, p as claim_component, r as mount_component, u as transition_in, z as add_render_callback, A as create_in_transition, w as transition_out, x as destroy_component } from './client.7016acc5.js';
import { T as Truman } from './Truman.6a74efc6.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t6 = claim_text(h2_nodes, "Aït Benhaddou");
			...
			figure1 = claim_element(div5_nodes, "FIGURE", {});
			...
			figure2 = claim_element(div5_nodes, "FIGURE", {});
			...
			figure3 = claim_element(div5_nodes, "FIGURE", {});
			...
			figure4 = claim_element(div5_nodes, "FIGURE", {});
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1srh4w8");
			add_location(h1, file$1, 55, 6, 1189);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 54, 4, 1159);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$1, 53, 2, 1131);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-1srh4w8");
			add_location(section, file$1, 49, 0, 1041);
			if (img0.src !== (img0_src_value = /*mank*/ ctx[1])) attr_dev(img0, "src", img0_src_value);
			attr_dev(img0, "alt", "man dances.");
			attr_dev(img0, "class", "svelte-1srh4w8");
			add_location(img0, file$1, 69, 10, 1542);
			add_location(figure0, file$1, 69, 2, 1534);
			attr_dev(div2, "class", "container image-gallery svelte-1srh4w8");
			add_location(div2, file$1, 68, 0, 1494);
			attr_dev(h2, "class", "svelte-1srh4w8");
			add_location(h2, file$1, 74, 4, 1653);
			attr_dev(p, "class", "svelte-1srh4w8");
			add_location(p, file$1, 75, 4, 1680);
			attr_dev(div3, "class", "chapter-header svelte-1srh4w8");
			add_location(div3, file$1, 73, 2, 1620);
			attr_dev(div4, "class", "container");
			add_location(div4, file$1, 72, 0, 1594);
			attr_dev(img1, "alt", "handsome man");
			if (img1.src !== (img1_src_value = "images/aaa.jpg")) attr_dev(img1, "src", img1_src_value);
			attr_dev(img1, "class", "svelte-1srh4w8");
			add_location(img1, file$1, 80, 10, 1758);
			add_location(figure1, file$1, 80, 2, 1750);
			attr_dev(img2, "alt", "handsome man");
			if (img2.src !== (img2_src_value = "images/bbb.jpg")) attr_dev(img2, "src", img2_src_value);
			attr_dev(img2, "class", "svelte-1srh4w8");
			add_location(img2, file$1, 81, 10, 1823);
			add_location(figure2, file$1, 81, 2, 1815);
			attr_dev(img3, "alt", "handsome man");
			if (img3.src !== (img3_src_value = "images/ccc.jpg")) attr_dev(img3, "src", img3_src_value);
			attr_dev(img3, "class", "svelte-1srh4w8");
			add_location(img3, file$1, 82, 10, 1888);
			add_location(figure3, file$1, 82, 2, 1880);
			attr_dev(img4, "alt", "handsome man");
			if (img4.src !== (img4_src_value = "images/ddd.jpg")) attr_dev(img4, "src", img4_src_value);
			attr_dev(img4, "class", "svelte-1srh4w8");
			add_location(img4, file$1, 83, 10, 1953);
			add_location(figure4, file$1, 83, 2, 1945);
			attr_dev(div5, "class", "container image-gallery svelte-1srh4w8");
			add_location(div5, file$1, 79, 0, 1710);
		},
		m: function mount(target, anchor) {
			...
			append_dev(div5, t11);
			append_dev(div5, figure3);
			append_dev(figure3, img3);
			append_dev(div5, t12);
			append_dev(div5, figure4);
