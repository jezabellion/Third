...
import { C as ChapterHeader } from './ChapterHeader.ed408863.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-v32ejv");
			add_location(img, file$3, 33, 12, 869);
			attr_dev(figure, "class", "svelte-v32ejv");
			add_location(figure, file$3, 33, 4, 861);
			attr_dev(div, "class", "container image-gallery svelte-v32ejv");
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-v32ejv");
			add_location(img, file$3, 41, 12, 1056);
			attr_dev(figure, "class", "svelte-v32ejv");
			add_location(figure, file$3, 41, 4, 1048);
			attr_dev(div, "class", "container image-gallery svelte-v32ejv");
			add_location(div, file$3, 40, 2, 1006);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-v32ejv");
			add_location(img, file$3, 49, 12, 1243);
			attr_dev(figure, "class", "svelte-v32ejv");
			add_location(figure, file$3, 49, 4, 1235);
			attr_dev(div, "class", "container image-gallery svelte-v32ejv");
			add_location(div, file$3, 48, 2, 1193);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
