...
import { M as ModalNav } from './ModalNav.6dc517ac.js';
import { C as ChapterHeader } from './ChapterHeader.e05b9d10.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1n7fnzh");
			add_location(h1, file$3, 121, 8, 2751);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 120, 6, 2719);
			attr_dev(div1, "class", "shoes hero-body svelte-1n7fnzh");
			add_location(div1, file$3, 119, 4, 2683);
			attr_dev(div2, "class", "hero-image svelte-1n7fnzh");
			add_location(div2, file$3, 118, 2, 2654);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1n7fnzh");
			add_location(a0, file$3, 132, 14, 3048);
			add_location(li0, file$3, 132, 10, 3044);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1n7fnzh");
			add_location(a1, file$3, 133, 14, 3107);
			add_location(li1, file$3, 133, 10, 3103);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1n7fnzh");
			add_location(a2, file$3, 134, 14, 3165);
			add_location(li2, file$3, 134, 10, 3161);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1n7fnzh");
			add_location(a3, file$3, 135, 14, 3225);
			add_location(li3, file$3, 135, 10, 3221);
			attr_dev(ul, "class", "svelte-1n7fnzh");
			add_location(ul, file$3, 130, 8, 2971);
			attr_dev(div3, "class", "container svelte-1n7fnzh");
			add_location(div3, file$3, 129, 6, 2939);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1n7fnzh");
			add_location(nav, file$3, 128, 4, 2901);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1n7fnzh");
			add_location(div4, file$3, 127, 2, 2856);
		},
		m: function mount(target, anchor) {
