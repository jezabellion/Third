...
import { M as ModalNav, d as destination } from './ModalNav.1dd3899c.js';
import { c as copy, b as backgroundHero, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.70e0e362.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 35, 6, 955);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 34, 4, 925);
			attr_dev(div1, "class", "hero-body svelte-1wp20ao");
			add_location(div1, file$1, 33, 2, 897);
			attr_dev(section, "class", "hero is-transparent is-fullheight svelte-1wp20ao");
			add_location(section, file$1, 29, 0, 823);
		},
