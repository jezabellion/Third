...
import { M as ModalNav } from './ModalNav.ccd03d8c.js';
import { C as ChapterHeader } from './ChapterHeader.de1ba9be.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$3, 148, 2, 3433);
			attr_dev(div5, "class", "column has-text-centered\t");
			add_location(div5, file$3, 147, 0, 3391);
