...
import { T as Truman } from './Truman.662af059.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 61, 11, 1467);
			add_location(figure, file$2, 61, 3, 1459);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 60, 1, 1418);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[6].alt);
			attr_dev(img, "class", "svelte-2ikc7i");
			add_location(img, file$2, 69, 11, 1629);
			add_location(figure, file$2, 69, 3, 1621);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 68, 1, 1580);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 52, 6, 1291);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 51, 4, 1261);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 50, 2, 1233);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-2ikc7i");
			add_location(section, file$2, 46, 0, 1142);
		},
		m: function mount(target, anchor) {
