...
import { M as ModalNav } from './ModalNav.a480cb9b.js';
import { C as ChapterHeader } from './ChapterHeader.90163eb7.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 26, 8, 643);
			attr_dev(a0, "class", "navbar-item svelte-1ry779h");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 25, 6, 601);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-1ry779h");
			add_location(span0, file, 29, 8, 875);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-1ry779h");
			add_location(span1, file, 30, 8, 916);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-1ry779h");
			add_location(span2, file, 31, 8, 957);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-1ry779h");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 28, 6, 736);
			attr_dev(div0, "class", "navbar-brand svelte-1ry779h");
			add_location(div0, file, 24, 4, 568);
			attr_dev(a2, "class", "navbar-item svelte-1ry779h");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 38, 10, 1140);
			attr_dev(a3, "class", "navbar-item svelte-1ry779h");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 39, 10, 1210);
			attr_dev(a4, "class", "navbar-item svelte-1ry779h");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 40, 10, 1281);
			attr_dev(a5, "class", "navbar-item svelte-1ry779h");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 41, 10, 1350);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 37, 8, 1099);
			attr_dev(div2, "class", "navbar-item svelte-1ry779h");
			add_location(div2, file, 36, 6, 1065);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 35, 4, 1017);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 23, 2, 518);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 22, 0, 492);
		},
