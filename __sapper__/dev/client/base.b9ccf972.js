import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, F as toggle_class, l as insert_dev, m as append_dev, G as run_all, H as listen_dev, n as noop } from './client.097d8e66.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 134, 8, 3442);
			attr_dev(div12, "class", "container");
			add_location(div12, file, 133, 6, 3410);
			attr_dev(div13, "class", "shoes hero-body svelte-10nssdk");
			add_location(div13, file, 132, 4, 3374);
			attr_dev(div14, "class", "hero-image svelte-10nssdk");
			add_location(div14, file, 131, 2, 3345);
			attr_dev(a5, "class", "svelte-10nssdk");
			add_location(a5, file, 144, 32, 3699);
			attr_dev(li0, "class", "is-active");
			add_location(li0, file, 144, 10, 3677);
			attr_dev(a6, "href", "travel");
			attr_dev(a6, "class", "svelte-10nssdk");
			add_location(a6, file, 145, 14, 3730);
			add_location(li1, file, 145, 10, 3726);
			attr_dev(a7, "href", "travel");
			attr_dev(a7, "class", "svelte-10nssdk");
			add_location(a7, file, 146, 14, 3778);
			add_location(li2, file, 146, 10, 3774);
			attr_dev(a8, "href", "travel");
			attr_dev(a8, "class", "svelte-10nssdk");
			add_location(a8, file, 147, 14, 3827);
			add_location(li3, file, 147, 10, 3823);
			attr_dev(a9, "href", "travel");
			attr_dev(a9, "class", "svelte-10nssdk");
			add_location(a9, file, 148, 14, 3874);
			add_location(li4, file, 148, 10, 3870);
			attr_dev(ul, "class", "svelte-10nssdk");
			add_location(ul, file, 143, 8, 3662);
			attr_dev(div15, "class", "container");
			add_location(div15, file, 142, 6, 3630);
			attr_dev(nav, "class", "tabs is-fullwidth");
			add_location(nav, file, 141, 4, 3592);
			attr_dev(div16, "class", "hero-foot is-hidden-mobile svelte-10nssdk");
			add_location(div16, file, 140, 2, 3547);
