...
import { T as Truman } from './Truman.9bddacb2.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 61, 11, 1341);
			add_location(figure, file$2, 61, 3, 1333);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 60, 1, 1292);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[4].alt);
			attr_dev(img, "class", "svelte-2ikc7i");
			add_location(img, file$2, 69, 11, 1503);
			add_location(figure, file$2, 69, 3, 1495);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 68, 1, 1454);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 46, 6, 1116);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 45, 4, 1086);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 44, 2, 1058);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-2ikc7i");
			add_location(section, file$2, 40, 0, 967);
			add_location(p, file$2, 53, 1, 1228);
			attr_dev(div2, "class", "container");
			add_location(div2, file$2, 52, 0, 1203);
		},
		m: function mount(target, anchor) {
