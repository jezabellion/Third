...
import { C as ChapterHeader } from './ChapterHeader.3c44be36.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1fuqexp");
			add_location(img, file$3, 31, 12, 825);
			attr_dev(figure, "class", "svelte-1fuqexp");
			add_location(figure, file$3, 31, 4, 817);
			attr_dev(div, "class", "container image-gallery svelte-1fuqexp");
			add_location(div, file$3, 30, 2, 775);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1fuqexp");
			add_location(img, file$3, 39, 12, 1012);
			attr_dev(figure, "class", "svelte-1fuqexp");
			add_location(figure, file$3, 39, 4, 1004);
			attr_dev(div, "class", "container image-gallery svelte-1fuqexp");
			add_location(div, file$3, 38, 2, 962);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1fuqexp");
			add_location(img, file$3, 47, 12, 1199);
			attr_dev(figure, "class", "svelte-1fuqexp");
			add_location(figure, file$3, 47, 4, 1191);
			attr_dev(div, "class", "container image-gallery svelte-1fuqexp");
			add_location(div, file$3, 46, 2, 1149);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
