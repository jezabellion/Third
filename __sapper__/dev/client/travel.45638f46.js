...
import { T as Truman } from './Truman.f38f5255.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$2, 24, 4, 567);
...
function create_fragment$3(ctx) {
	...
	let t1;
	let p0;
	let t2_value = chapter$1.one + "";
	let t2;
	let t3;
	let p1;
	let t4_value = chapter$1.two + "";
	let t4;
	let t5;
	let t6;
	let t7;
