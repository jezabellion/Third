...
import { d as destination, b as blurb, c as chapter, p as photosOne, a as photosTwo } from './morocco.18f9246d.js';
import { C as ChapterHeader } from './ChapterHeader.fd6ccceb.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-fl2165");
			add_location(img, file$3, 27, 12, 737);
			attr_dev(figure, "class", "svelte-fl2165");
			add_location(figure, file$3, 27, 4, 729);
			attr_dev(div, "class", "container image-gallery");
			add_location(div, file$3, 26, 2, 687);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-fl2165");
			add_location(img, file$3, 35, 12, 924);
			attr_dev(figure, "class", "svelte-fl2165");
			add_location(figure, file$3, 35, 4, 916);
			attr_dev(div, "class", "container image-gallery");
			add_location(div, file$3, 34, 2, 874);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-fl2165");
			add_location(img, file$3, 43, 12, 1111);
			attr_dev(figure, "class", "svelte-fl2165");
			add_location(figure, file$3, 43, 4, 1103);
			attr_dev(div, "class", "container image-gallery");
			add_location(div, file$3, 42, 2, 1061);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
