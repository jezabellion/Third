...
import { T as Truman } from './Truman.21a5a8f9.js';
import { d as destination, C as ChapterHeader, c as chapter, p as photosOne, a as photosTwo, b as chapterOne, e as chapterTwo } from './ChapterHeader.efda68cd.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$2, 50, 12, 1164);
			add_location(figure, file$2, 50, 4, 1156);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$2, 49, 2, 1114);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
