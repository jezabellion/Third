...
import { M as ModalNav } from './ModalNav.5806bfd1.js';
import { C as ChapterHeader } from './ChapterHeader.573106ac.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1y53tes");
			add_location(h1, file$3, 126, 8, 2771);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 125, 6, 2739);
			attr_dev(div1, "class", "shoes hero-body svelte-1y53tes");
			add_location(div1, file$3, 124, 4, 2703);
			attr_dev(div2, "class", "hero-image svelte-1y53tes");
			add_location(div2, file$3, 123, 2, 2674);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1y53tes");
			add_location(a0, file$3, 137, 14, 3068);
			add_location(li0, file$3, 137, 10, 3064);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1y53tes");
			add_location(a1, file$3, 138, 14, 3127);
			add_location(li1, file$3, 138, 10, 3123);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1y53tes");
			add_location(a2, file$3, 139, 14, 3185);
			add_location(li2, file$3, 139, 10, 3181);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1y53tes");
			add_location(a3, file$3, 140, 14, 3245);
			add_location(li3, file$3, 140, 10, 3241);
			attr_dev(ul, "class", "svelte-1y53tes");
			add_location(ul, file$3, 135, 8, 2991);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 134, 6, 2959);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1y53tes");
			add_location(nav, file$3, 133, 4, 2921);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1y53tes");
			add_location(div4, file$3, 132, 2, 2876);
			attr_dev(button, "class", "button is-white svelte-1y53tes");
			add_location(button, file$3, 149, 4, 3444);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 148, 2, 3401);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 147, 0, 3358);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
