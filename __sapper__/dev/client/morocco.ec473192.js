...
import { M as ModalNav } from './ModalNav.95d1bd86.js';
import { C as ChapterHeader } from './ChapterHeader.ed11f138.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 23, 8, 603);
			attr_dev(a0, "class", "navbar-item svelte-15dc5fp");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 22, 6, 561);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-15dc5fp");
			add_location(span0, file, 26, 8, 835);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-15dc5fp");
			add_location(span1, file, 27, 8, 876);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-15dc5fp");
			add_location(span2, file, 28, 8, 917);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-15dc5fp");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 25, 6, 696);
			attr_dev(div0, "class", "navbar-brand svelte-15dc5fp");
			add_location(div0, file, 21, 4, 528);
			attr_dev(a2, "class", "navbar-item svelte-15dc5fp");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 35, 10, 1100);
			attr_dev(a3, "class", "navbar-item svelte-15dc5fp");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 36, 10, 1170);
			attr_dev(a4, "class", "navbar-item svelte-15dc5fp");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 37, 10, 1241);
			attr_dev(a5, "class", "navbar-item svelte-15dc5fp");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 38, 10, 1310);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 34, 8, 1059);
			attr_dev(div2, "class", "navbar-item svelte-15dc5fp");
			add_location(div2, file, 33, 6, 1025);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 32, 4, 977);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 20, 2, 478);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 19, 0, 452);
		},
