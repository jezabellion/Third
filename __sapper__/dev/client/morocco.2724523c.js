...
import { M as ModalNav } from './ModalNav.a4fd1f48.js';
import { C as ChapterHeader } from './ChapterHeader.5263722b.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 23, 8, 617);
			attr_dev(a0, "class", "navbar-item svelte-17t7i40");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 22, 6, 575);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-17t7i40");
			add_location(span0, file, 26, 8, 849);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-17t7i40");
			add_location(span1, file, 27, 8, 890);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-17t7i40");
			add_location(span2, file, 28, 8, 931);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-17t7i40");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 25, 6, 710);
			attr_dev(div0, "class", "navbar-brand svelte-17t7i40");
			add_location(div0, file, 21, 4, 542);
			attr_dev(a2, "class", "navbar-item svelte-17t7i40");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 35, 10, 1114);
			attr_dev(a3, "class", "navbar-item svelte-17t7i40");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 36, 10, 1184);
			attr_dev(a4, "class", "navbar-item svelte-17t7i40");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 37, 10, 1255);
			attr_dev(a5, "class", "navbar-item svelte-17t7i40");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 38, 10, 1324);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 34, 8, 1073);
			attr_dev(div2, "class", "navbar-item svelte-17t7i40");
			add_location(div2, file, 33, 6, 1039);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 32, 4, 991);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 20, 2, 492);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 19, 0, 466);
		},
