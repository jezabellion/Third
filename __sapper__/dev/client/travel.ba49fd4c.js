import { y as identity, S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, B as Bonkers, v as validate_slots, a as space, e as element, o as create_component, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, p as claim_component, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, r as mount_component, m as append_dev, u as transition_in, z as add_render_callback, A as create_in_transition, w as transition_out, x as destroy_component } from './client.bf7c299d.js';
import { T as Truman } from './Truman.5588ff70.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 65, 6, 1354);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 64, 4, 1324);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file, 63, 2, 1296);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-1abxzzq");
			add_location(section, file, 59, 0, 1206);
			attr_dev(p0, "class", "svelte-1abxzzq");
			add_location(p0, file, 71, 2, 1472);
			attr_dev(p1, "class", "svelte-1abxzzq");
			add_location(p1, file, 72, 2, 1594);
			attr_dev(p2, "class", "svelte-1abxzzq");
			add_location(p2, file, 73, 2, 1609);
			attr_dev(div2, "class", "container blurb svelte-1abxzzq");
			add_location(div2, file, 70, 0, 1440);
			if (img0.src !== (img0_src_value = src)) attr_dev(img0, "src", img0_src_value);
			attr_dev(img0, "alt", img0_alt_value = "" + (name + " dances."));
			attr_dev(img0, "class", "svelte-1abxzzq");
			add_location(img0, file, 77, 10, 1688);
			add_location(figure0, file, 77, 2, 1680);
			attr_dev(div3, "class", "container image-gallery svelte-1abxzzq");
			add_location(div3, file, 76, 0, 1640);
