...
import { C as ChapterHeader } from './ChapterHeader.6aa879dd.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p0, "class", "svelte-dkqqhd");
			add_location(p0, file$2, 26, 2, 566);
			attr_dev(p1, "class", "svelte-dkqqhd");
			add_location(p1, file$2, 27, 2, 587);
			attr_dev(p2, "class", "svelte-dkqqhd");
			add_location(p2, file$2, 28, 2, 602);
			attr_dev(div, "class", "container blurb svelte-dkqqhd");
