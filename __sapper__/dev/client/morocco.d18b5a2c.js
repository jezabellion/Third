...
import { M as ModalNav } from './ModalNav.872d6b62.js';
import { C as ChapterHeader } from './ChapterHeader.3c532b51.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 114, 8, 2642);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 113, 6, 2610);
			attr_dev(div1, "class", "shoes hero-body svelte-phw0zu");
			add_location(div1, file$3, 112, 4, 2574);
			attr_dev(div2, "class", "hero-image svelte-phw0zu");
			add_location(div2, file$3, 111, 2, 2545);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-phw0zu");
			add_location(a0, file$3, 125, 14, 2939);
			add_location(li0, file$3, 125, 10, 2935);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-phw0zu");
			add_location(a1, file$3, 126, 14, 2998);
			add_location(li1, file$3, 126, 10, 2994);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-phw0zu");
			add_location(a2, file$3, 127, 14, 3056);
			add_location(li2, file$3, 127, 10, 3052);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-phw0zu");
			add_location(a3, file$3, 128, 14, 3116);
			add_location(li3, file$3, 128, 10, 3112);
			attr_dev(ul, "class", "svelte-phw0zu");
			add_location(ul, file$3, 123, 8, 2862);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 122, 6, 2830);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-phw0zu");
			add_location(nav, file$3, 121, 4, 2792);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-phw0zu");
			add_location(div4, file$3, 120, 2, 2747);
		},
		m: function mount(target, anchor) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
