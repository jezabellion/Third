...
import { M as ModalNav, d as destination } from './ModalNav.e7f2174c.js';
import { c as copy, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.7cde3436.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$4, 34, 12, 943);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 34, 4, 935);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 33, 2, 893);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 42, 12, 1131);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 42, 4, 1123);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 41, 2, 1081);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
