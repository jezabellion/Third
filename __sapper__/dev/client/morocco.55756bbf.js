...
import { M as ModalNav } from './ModalNav.983001f5.js';
import { C as ChapterHeader } from './ChapterHeader.fadf0d95.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a0, "class", "svelte-vi31pu");
			...
			add_location(a1, file$3, 104, 14, 2252);
			add_location(li1, file$3, 104, 10, 2248);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-vi31pu");
			add_location(a2, file$3, 105, 14, 2310);
			add_location(li2, file$3, 105, 10, 2306);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-vi31pu");
			add_location(a3, file$3, 106, 14, 2370);
			add_location(li3, file$3, 106, 10, 2366);
			...
			add_location(button, file$3, 115, 4, 2569);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 114, 2, 2526);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 113, 0, 2483);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
