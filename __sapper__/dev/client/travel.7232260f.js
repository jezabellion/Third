...
import { T as Truman } from './Truman.3c9d44f9.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 34, 12, 854);
			add_location(figure, file$3, 34, 4, 846);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 33, 2, 804);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 43, 12, 1022);
			add_location(figure, file$3, 43, 4, 1014);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 42, 2, 972);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
// (50:1) {#each photosTwo as photo, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 51, 12, 1189);
			add_location(figure, file$3, 51, 4, 1181);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 50, 2, 1139);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(50:1) {#each photosTwo as photo, i}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$3, 27, 0, 736);
		},
		m: function mount(target, anchor) {
			...
			if (dirty & /*photosOne*/ 0) {
				...
				for (i = 0; i < each_value_2.length; i += 1) {
					...
					if (each_blocks_2[i]) {
						...
						each_blocks_2[i].c();
						each_blocks_2[i].m(t9.parentNode, t9);
					}
				}
