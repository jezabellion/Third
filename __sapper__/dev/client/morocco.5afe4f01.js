...
import { C as ChapterHeader } from './ChapterHeader.3e5c0c73.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 15, 8, 647);
			attr_dev(a0, "class", "navbar-item");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 14, 6, 605);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-vnlgr4");
			add_location(span0, file, 18, 8, 845);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-vnlgr4");
			add_location(span1, file, 19, 8, 886);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-vnlgr4");
			add_location(span2, file, 20, 8, 927);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-vnlgr4");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 17, 6, 740);
			attr_dev(div0, "class", "navbar-brand");
			add_location(div0, file, 13, 4, 572);
			attr_dev(a2, "class", "navbar-item");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 27, 10, 1110);
			attr_dev(a3, "class", "navbar-item");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 28, 10, 1180);
			attr_dev(a4, "class", "navbar-item");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 29, 10, 1251);
			attr_dev(a5, "class", "navbar-item");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 30, 10, 1320);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 26, 8, 1069);
			attr_dev(div2, "class", "navbar-item");
			add_location(div2, file, 25, 6, 1035);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 24, 4, 987);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 12, 2, 522);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 11, 0, 496);
		},
