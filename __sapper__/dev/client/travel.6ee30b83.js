...
import { T as Truman } from './Truman.475c2195.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 36, 12, 922);
			add_location(figure, file$3, 36, 4, 914);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 35, 2, 872);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 44, 12, 1089);
			add_location(figure, file$3, 44, 4, 1081);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 43, 2, 1039);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
