...
import { T as Truman } from './Truman.45e6e527.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 32, 12, 830);
			add_location(figure, file$3, 32, 4, 822);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 31, 2, 780);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 41, 12, 1020);
			add_location(figure, file$3, 41, 4, 1012);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 40, 2, 970);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 49, 12, 1207);
			add_location(figure, file$3, 49, 4, 1199);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 48, 2, 1157);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
