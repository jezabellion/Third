...
import { M as ModalNav } from './ModalNav.af2babc0.js';
import { C as ChapterHeader } from './ChapterHeader.be1dc8b1.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-4y9qat");
			add_location(h1, file$3, 121, 8, 2725);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 120, 6, 2693);
			attr_dev(div1, "class", "shoes hero-body svelte-4y9qat");
			add_location(div1, file$3, 119, 4, 2657);
			attr_dev(div2, "class", "hero-image svelte-4y9qat");
			add_location(div2, file$3, 118, 2, 2628);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-4y9qat");
			add_location(a0, file$3, 132, 14, 3022);
			add_location(li0, file$3, 132, 10, 3018);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-4y9qat");
			add_location(a1, file$3, 133, 14, 3081);
			add_location(li1, file$3, 133, 10, 3077);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-4y9qat");
			add_location(a2, file$3, 134, 14, 3139);
			add_location(li2, file$3, 134, 10, 3135);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-4y9qat");
			add_location(a3, file$3, 135, 14, 3199);
			add_location(li3, file$3, 135, 10, 3195);
			attr_dev(ul, "class", "svelte-4y9qat");
			add_location(ul, file$3, 130, 8, 2945);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 129, 6, 2913);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-4y9qat");
			add_location(nav, file$3, 128, 4, 2875);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-4y9qat");
			add_location(div4, file$3, 127, 2, 2830);
		},
		m: function mount(target, anchor) {
