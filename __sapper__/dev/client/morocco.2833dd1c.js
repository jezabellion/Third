...
import { M as ModalNav } from './ModalNav.780fa786.js';
import { C as ChapterHeader } from './ChapterHeader.745eee87.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-vzhzoy");
			add_location(h1, file$3, 102, 8, 2098);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 101, 6, 2066);
			attr_dev(div1, "class", "shoes hero-body svelte-vzhzoy");
			add_location(div1, file$3, 100, 4, 2030);
			attr_dev(div2, "class", "hero-image svelte-vzhzoy");
			add_location(div2, file$3, 99, 2, 2001);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-vzhzoy");
			add_location(a0, file$3, 113, 14, 2395);
			add_location(li0, file$3, 113, 10, 2391);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-vzhzoy");
			add_location(a1, file$3, 114, 14, 2454);
			add_location(li1, file$3, 114, 10, 2450);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-vzhzoy");
			add_location(a2, file$3, 115, 14, 2512);
			add_location(li2, file$3, 115, 10, 2508);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-vzhzoy");
			add_location(a3, file$3, 116, 14, 2572);
			add_location(li3, file$3, 116, 10, 2568);
			attr_dev(ul, "class", "svelte-vzhzoy");
			add_location(ul, file$3, 111, 8, 2318);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 110, 6, 2286);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-vzhzoy");
			add_location(nav, file$3, 109, 4, 2248);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-vzhzoy");
			add_location(div4, file$3, 108, 2, 2203);
			attr_dev(button, "class", "button is-white svelte-vzhzoy");
			add_location(button, file$3, 125, 4, 2771);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 124, 2, 2728);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 123, 0, 2685);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
