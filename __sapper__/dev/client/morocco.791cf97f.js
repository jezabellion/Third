...
import { C as ChapterHeader } from './ChapterHeader.af8749e1.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-sgjxxd");
			add_location(img, file$3, 33, 12, 867);
			attr_dev(figure, "class", "svelte-sgjxxd");
			add_location(figure, file$3, 33, 4, 859);
			attr_dev(div, "class", "container image-gallery svelte-sgjxxd");
