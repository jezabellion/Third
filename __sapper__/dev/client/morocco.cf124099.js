...
import { M as ModalNav, d as destination } from './ModalNav.2e59246c.js';
import { c as copy$1, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.003bc88e.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p1, file$3, 29, 2, 636);
			attr_dev(p2, "class", "svelte-oqf5m0");
			add_location(p2, file$3, 30, 2, 651);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ blurbCopy, travelers });
