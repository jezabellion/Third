...
import { M as ModalNav } from './ModalNav.3c5304a7.js';
import { C as ChapterHeader } from './ChapterHeader.c89f8f59.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 27, 8, 666);
			attr_dev(a0, "class", "navbar-item svelte-dwc0ou");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 26, 6, 624);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-dwc0ou");
			add_location(span0, file, 30, 8, 898);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-dwc0ou");
			add_location(span1, file, 31, 8, 939);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-dwc0ou");
			add_location(span2, file, 32, 8, 980);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-dwc0ou");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 29, 6, 759);
			attr_dev(div0, "class", "navbar-brand svelte-dwc0ou");
			add_location(div0, file, 25, 4, 591);
			attr_dev(a2, "class", "navbar-item svelte-dwc0ou");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 39, 10, 1163);
			attr_dev(a3, "class", "navbar-item svelte-dwc0ou");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 40, 10, 1233);
			attr_dev(a4, "class", "navbar-item svelte-dwc0ou");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 41, 10, 1304);
			attr_dev(a5, "class", "navbar-item svelte-dwc0ou");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 42, 10, 1373);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 38, 8, 1122);
			attr_dev(div2, "class", "navbar-item svelte-dwc0ou");
			add_location(div2, file, 37, 6, 1088);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 36, 4, 1040);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 24, 2, 541);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 23, 0, 515);
		},
