...
import { C as ChapterHeader } from './ChapterHeader.5f1a16a9.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 18, 8, 519);
			attr_dev(a0, "class", "navbar-item");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 17, 6, 477);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-2brar");
			add_location(span0, file, 21, 8, 717);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-2brar");
			add_location(span1, file, 22, 8, 758);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-2brar");
			add_location(span2, file, 23, 8, 799);
