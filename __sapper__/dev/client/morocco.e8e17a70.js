...
import { M as ModalNav } from './ModalNav.d0fa80b2.js';
import { C as ChapterHeader } from './ChapterHeader.85a5367a.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t11 = claim_text(button_nodes, "Whatever");
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 121, 8, 2723);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 120, 6, 2691);
			attr_dev(div1, "class", "shoes hero-body svelte-1uftri7");
			add_location(div1, file$3, 119, 4, 2655);
			attr_dev(div2, "class", "hero-image svelte-1uftri7");
			add_location(div2, file$3, 118, 2, 2626);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1uftri7");
			add_location(a0, file$3, 132, 14, 3020);
			add_location(li0, file$3, 132, 10, 3016);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1uftri7");
			add_location(a1, file$3, 133, 14, 3079);
			add_location(li1, file$3, 133, 10, 3075);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1uftri7");
			add_location(a2, file$3, 134, 14, 3137);
			add_location(li2, file$3, 134, 10, 3133);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1uftri7");
			add_location(a3, file$3, 135, 14, 3197);
			add_location(li3, file$3, 135, 10, 3193);
			attr_dev(ul, "class", "svelte-1uftri7");
			add_location(ul, file$3, 130, 8, 2943);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 129, 6, 2911);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1uftri7");
			add_location(nav, file$3, 128, 4, 2873);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1uftri7");
			add_location(div4, file$3, 127, 2, 2828);
			add_location(button, file$3, 143, 2, 3355);
			attr_dev(div5, "class", "is-hidden-tablet is-centered");
			add_location(div5, file$3, 142, 0, 3310);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
