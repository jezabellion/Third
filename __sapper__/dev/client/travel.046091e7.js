...
import { T as Truman } from './Truman.ba33e72c.js';
...
// (41:0) {#each photosOne as photo, i}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 42, 11, 1004);
			add_location(figure, file$2, 42, 3, 996);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$2, 41, 1, 955);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(41:0) {#each photosOne as photo, i}",
		ctx
	});
...
// (49:0) {#each photosTwo as photo, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[6].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$2, 50, 11, 1166);
			add_location(figure, file$2, 50, 3, 1158);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$2, 49, 1, 1117);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(49:0) {#each photosTwo as photo, i}",
		ctx
	});
