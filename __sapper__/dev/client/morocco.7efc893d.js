...
import { M as ModalNav, d as destination } from './ModalNav.3f76c629.js';
import { c as copy, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.c84868e3.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 33, 6, 917);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 32, 4, 887);
			attr_dev(div1, "class", "hero-body svelte-2zr7eb");
			add_location(div1, file$1, 31, 2, 859);
			set_style(section, "background-image", /*backgroundHero*/ ctx[1].morocco);
			attr_dev(section, "class", "hero is-transparent is-fullheight svelte-2zr7eb");
			add_location(section, file$1, 27, 0, 734);
		},
