...
import { M as ModalNav } from './ModalNav.8061bdbf.js';
import { C as ChapterHeader } from './ChapterHeader.6639eea5.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 28, 8, 705);
			attr_dev(a0, "class", "navbar-item svelte-g639j1");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 27, 6, 663);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-g639j1");
			add_location(span0, file, 31, 8, 937);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-g639j1");
			add_location(span1, file, 32, 8, 978);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-g639j1");
			add_location(span2, file, 33, 8, 1019);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-g639j1");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 30, 6, 798);
			attr_dev(div0, "class", "navbar-brand svelte-g639j1");
			add_location(div0, file, 26, 4, 630);
			attr_dev(a2, "class", "navbar-item is-active svelte-g639j1");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 40, 10, 1202);
			attr_dev(a3, "class", "navbar-item svelte-g639j1");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 41, 10, 1282);
			attr_dev(a4, "class", "navbar-item svelte-g639j1");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 42, 10, 1353);
			attr_dev(a5, "class", "navbar-item svelte-g639j1");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 43, 10, 1422);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 39, 8, 1161);
			attr_dev(div2, "class", "navbar-item svelte-g639j1");
			add_location(div2, file, 38, 6, 1127);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 37, 4, 1079);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 25, 2, 580);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 24, 0, 554);
		},
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1s1t5gp");
			add_location(h1, file$3, 92, 8, 1895);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 91, 6, 1863);
			attr_dev(div1, "class", "shoes hero-body svelte-1s1t5gp");
			add_location(div1, file$3, 90, 4, 1827);
			attr_dev(div2, "class", "hero-image svelte-1s1t5gp");
			add_location(div2, file$3, 89, 2, 1798);
			attr_dev(a0, "class", "is-active svelte-1s1t5gp");
			attr_dev(a0, "href", "morocco");
			add_location(a0, file$3, 103, 14, 2192);
			add_location(li0, file$3, 103, 10, 2188);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1s1t5gp");
			add_location(a1, file$3, 104, 14, 2269);
			add_location(li1, file$3, 104, 10, 2265);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1s1t5gp");
			add_location(a2, file$3, 105, 14, 2327);
			add_location(li2, file$3, 105, 10, 2323);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1s1t5gp");
			add_location(a3, file$3, 106, 14, 2387);
			add_location(li3, file$3, 106, 10, 2383);
			attr_dev(ul, "class", "svelte-1s1t5gp");
			add_location(ul, file$3, 101, 8, 2115);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 100, 6, 2083);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1s1t5gp");
			add_location(nav, file$3, 99, 4, 2045);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1s1t5gp");
			add_location(div4, file$3, 98, 2, 2000);
			attr_dev(button, "class", "button is-white svelte-1s1t5gp");
			add_location(button, file$3, 115, 4, 2586);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 114, 2, 2543);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 113, 0, 2500);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
