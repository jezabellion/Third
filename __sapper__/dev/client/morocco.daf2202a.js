...
import { C as ChapterHeader } from './ChapterHeader.7db22aa6.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1xpytpk");
			add_location(img, file$3, 33, 12, 873);
			attr_dev(figure, "class", "svelte-1xpytpk");
			add_location(figure, file$3, 33, 4, 865);
			attr_dev(div, "class", "container image-gallery svelte-1xpytpk");
