...
import { M as ModalNav } from './ModalNav.5f2a6bd1.js';
import { C as ChapterHeader } from './ChapterHeader.032840ba.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 35, 6, 920);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 34, 4, 890);
			attr_dev(div1, "class", "hero-body svelte-1uczkwb");
			add_location(div1, file$1, 33, 2, 862);
			attr_dev(section, "class", "hero is-fullheight-with-navbar svelte-1uczkwb");
