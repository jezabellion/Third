...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file, 68, 2, 1305);
			attr_dev(p1, "class", "svelte-182jq4i");
			add_location(p1, file, 69, 2, 1427);
			attr_dev(p2, "class", "svelte-182jq4i");
			add_location(p2, file, 70, 2, 1442);
			attr_dev(div2, "class", "container blurb svelte-182jq4i");
			add_location(div2, file, 67, 0, 1273);
			...
			add_location(img0, file, 74, 10, 1521);
			add_location(figure0, file, 74, 2, 1513);
			attr_dev(div3, "class", "container image-gallery svelte-182jq4i");
			add_location(div3, file, 73, 0, 1473);
			attr_dev(h2, "class", "svelte-182jq4i");
			add_location(h2, file, 79, 4, 1643);
			attr_dev(p3, "class", "svelte-182jq4i");
			add_location(p3, file, 80, 4, 1670);
			attr_dev(div4, "class", "chapter-header svelte-182jq4i");
			add_location(div4, file, 78, 2, 1610);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 77, 0, 1584);
			...
			add_location(img1, file, 85, 10, 1748);
			add_location(figure1, file, 85, 2, 1740);
			...
			add_location(img2, file, 86, 10, 1813);
			add_location(figure2, file, 86, 2, 1805);
			...
			add_location(img3, file, 87, 10, 1878);
			add_location(figure3, file, 87, 2, 1870);
			...
			add_location(img4, file, 88, 10, 1943);
			add_location(figure4, file, 88, 2, 1935);
			attr_dev(div6, "class", "container image-gallery svelte-182jq4i");
			add_location(div6, file, 84, 0, 1700);
		},
