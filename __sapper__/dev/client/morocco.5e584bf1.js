...
import { M as ModalNav } from './ModalNav.77851055.js';
import { C as ChapterHeader } from './ChapterHeader.3a4a194d.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1nsaoty");
			add_location(h1, file$3, 91, 8, 1897);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 90, 6, 1865);
			attr_dev(div1, "class", "shoes hero-body svelte-1nsaoty");
			add_location(div1, file$3, 89, 4, 1829);
			attr_dev(div2, "class", "hero-image svelte-1nsaoty");
			add_location(div2, file$3, 88, 2, 1800);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1nsaoty");
			add_location(a0, file$3, 102, 14, 2194);
			add_location(li0, file$3, 102, 10, 2190);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1nsaoty");
			add_location(a1, file$3, 103, 14, 2253);
			add_location(li1, file$3, 103, 10, 2249);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1nsaoty");
			add_location(a2, file$3, 104, 14, 2311);
			add_location(li2, file$3, 104, 10, 2307);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1nsaoty");
			add_location(a3, file$3, 105, 14, 2371);
			add_location(li3, file$3, 105, 10, 2367);
			attr_dev(ul, "class", "svelte-1nsaoty");
			add_location(ul, file$3, 100, 8, 2117);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 99, 6, 2085);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1nsaoty");
			add_location(nav, file$3, 98, 4, 2047);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1nsaoty");
			add_location(div4, file$3, 97, 2, 2002);
			attr_dev(button, "class", "button is-white svelte-1nsaoty");
			add_location(button, file$3, 114, 4, 2570);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 113, 2, 2527);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 112, 0, 2484);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
