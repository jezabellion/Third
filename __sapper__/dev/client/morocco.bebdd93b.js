...
import { M as ModalNav } from './ModalNav.ea9faa2d.js';
import { C as ChapterHeader } from './ChapterHeader.273c915e.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "width", "112");
			attr_dev(img, "height", "28");
			add_location(img, file$3, 95, 12, 2133);
			attr_dev(a0, "class", "navbar-item svelte-phw0zu");
			attr_dev(a0, "href", "./");
			add_location(a0, file$3, 94, 10, 2087);
			add_location(span0, file$3, 98, 12, 2336);
			add_location(span1, file$3, 99, 12, 2362);
			add_location(span2, file$3, 100, 12, 2388);
			attr_dev(span3, "class", "navbar-burger burger svelte-phw0zu");
			attr_dev(span3, "data-target", "navbarMenuHeroC");
			add_location(span3, file$3, 97, 10, 2224);
			attr_dev(div0, "class", "navbar-brand is-hidden-tablet svelte-phw0zu");
			add_location(div0, file$3, 93, 8, 2033);
			attr_dev(div1, "class", "container");
			add_location(div1, file$3, 92, 6, 2001);
			attr_dev(header, "class", "navbar");
			add_location(header, file$3, 91, 4, 1971);
			attr_dev(div2, "class", "hero-head");
			add_location(div2, file$3, 90, 2, 1943);
			attr_dev(h1, "class", "svelte-phw0zu");
			add_location(h1, file$3, 118, 8, 2643);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 117, 6, 2611);
			attr_dev(div4, "class", "shoes hero-body svelte-phw0zu");
			add_location(div4, file$3, 116, 4, 2575);
			attr_dev(div5, "class", "hero-image svelte-phw0zu");
			add_location(div5, file$3, 115, 2, 2546);
			attr_dev(a1, "href", "morocco");
			attr_dev(a1, "class", "svelte-phw0zu");
			add_location(a1, file$3, 129, 14, 2940);
			add_location(li0, file$3, 129, 10, 2936);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-phw0zu");
			add_location(a2, file$3, 130, 14, 2999);
			add_location(li1, file$3, 130, 10, 2995);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-phw0zu");
			add_location(a3, file$3, 131, 14, 3057);
			add_location(li2, file$3, 131, 10, 3053);
			attr_dev(a4, "href", "travel");
			attr_dev(a4, "class", "svelte-phw0zu");
			add_location(a4, file$3, 132, 14, 3117);
			add_location(li3, file$3, 132, 10, 3113);
			attr_dev(ul, "class", "svelte-phw0zu");
			add_location(ul, file$3, 127, 8, 2863);
			attr_dev(div6, "class", "container");
			add_location(div6, file$3, 126, 6, 2831);
			attr_dev(nav, "class", "tabs is-fullwidth");
			add_location(nav, file$3, 125, 4, 2793);
			attr_dev(div7, "class", "hero-foot is-hidden-mobile svelte-phw0zu");
			add_location(div7, file$3, 124, 2, 2748);
