...
import { T as Truman } from './Truman.0b5818d1.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 51, 11, 1215);
			add_location(figure, file$2, 51, 3, 1207);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 50, 1, 1166);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$2, 58, 10, 1345);
			add_location(figure0, file$2, 58, 2, 1337);
			...
			add_location(img1, file$2, 59, 10, 1410);
			add_location(figure1, file$2, 59, 2, 1402);
			...
			add_location(img2, file$2, 60, 10, 1475);
			add_location(figure2, file$2, 60, 2, 1467);
			...
			add_location(img3, file$2, 61, 10, 1540);
			add_location(figure3, file$2, 61, 2, 1532);
			attr_dev(div2, "class", "container image-gallery svelte-2ikc7i");
			add_location(div2, file$2, 57, 0, 1297);
		},
		m: function mount(target, anchor) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ("mank" in $$props) mank = $$props.mank;
	};
