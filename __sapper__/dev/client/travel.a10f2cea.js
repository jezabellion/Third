...
import { T as Truman } from './Truman.cc7ec446.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 59, 11, 1338);
			add_location(figure, file$2, 59, 3, 1330);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 58, 1, 1289);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[4].alt);
			attr_dev(img, "class", "svelte-2ikc7i");
			add_location(img, file$2, 67, 11, 1500);
			add_location(figure, file$2, 67, 3, 1492);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 66, 1, 1451);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 44, 6, 1113);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 43, 4, 1083);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 42, 2, 1055);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-2ikc7i");
			add_location(section, file$2, 38, 0, 964);
			add_location(p, file$2, 51, 1, 1225);
			attr_dev(div2, "class", "container");
			add_location(div2, file$2, 50, 0, 1200);
		},
		m: function mount(target, anchor) {
