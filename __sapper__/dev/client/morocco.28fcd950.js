...
import { M as ModalNav } from './ModalNav.05fb5c26.js';
import { C as ChapterHeader } from './ChapterHeader.5632965f.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-t7oehr");
			add_location(h1, file$3, 118, 8, 2700);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 117, 6, 2668);
			attr_dev(div1, "class", "shoes hero-body svelte-t7oehr");
			add_location(div1, file$3, 116, 4, 2632);
			attr_dev(div2, "class", "hero-image svelte-t7oehr");
			add_location(div2, file$3, 115, 2, 2603);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-t7oehr");
			add_location(a0, file$3, 129, 14, 2997);
			add_location(li0, file$3, 129, 10, 2993);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-t7oehr");
			add_location(a1, file$3, 130, 14, 3056);
			add_location(li1, file$3, 130, 10, 3052);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-t7oehr");
			add_location(a2, file$3, 131, 14, 3114);
			add_location(li2, file$3, 131, 10, 3110);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-t7oehr");
			add_location(a3, file$3, 132, 14, 3174);
			add_location(li3, file$3, 132, 10, 3170);
			attr_dev(ul, "class", "svelte-t7oehr");
			add_location(ul, file$3, 127, 8, 2920);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 126, 6, 2888);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-t7oehr");
			add_location(nav, file$3, 125, 4, 2850);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-t7oehr");
			add_location(div4, file$3, 124, 2, 2805);
		},
		m: function mount(target, anchor) {
