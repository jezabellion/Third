...
import { C as ChapterHeader } from './ChapterHeader.f137dff5.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-krzmup");
			add_location(img, file$3, 27, 12, 737);
			attr_dev(figure, "class", "svelte-krzmup");
