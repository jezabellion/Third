import { y as identity, S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, B as Bonkers, v as validate_slots, a as space, e as element, o as create_component, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, p as claim_component, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, r as mount_component, m as append_dev, u as transition_in, z as add_render_callback, A as create_in_transition, w as transition_out, x as destroy_component } from './client.c8423df5.js';
import { T as Truman } from './Truman.e7d92169.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 64, 6, 1322);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 63, 4, 1292);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file, 62, 2, 1264);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-1abxzzq");
			add_location(section, file, 58, 0, 1174);
			attr_dev(p0, "class", "svelte-1abxzzq");
			add_location(p0, file, 70, 2, 1440);
			attr_dev(p1, "class", "svelte-1abxzzq");
			add_location(p1, file, 71, 2, 1562);
			attr_dev(p2, "class", "svelte-1abxzzq");
			add_location(p2, file, 72, 2, 1577);
			attr_dev(div2, "class", "container blurb svelte-1abxzzq");
			add_location(div2, file, 69, 0, 1408);
			...
			add_location(img0, file, 76, 10, 1656);
			add_location(figure0, file, 76, 2, 1648);
			attr_dev(div3, "class", "container image-gallery svelte-1abxzzq");
			add_location(div3, file, 75, 0, 1608);
			attr_dev(h2, "class", "svelte-1abxzzq");
			add_location(h2, file, 81, 4, 1778);
			attr_dev(p3, "class", "svelte-1abxzzq");
			add_location(p3, file, 82, 4, 1805);
			attr_dev(div4, "class", "chapter-header svelte-1abxzzq");
			add_location(div4, file, 80, 2, 1745);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 79, 0, 1719);
			...
			add_location(img1, file, 87, 10, 1883);
			add_location(figure1, file, 87, 2, 1875);
			...
			add_location(img2, file, 88, 10, 1948);
			add_location(figure2, file, 88, 2, 1940);
			...
			add_location(img3, file, 89, 10, 2013);
			add_location(figure3, file, 89, 2, 2005);
			...
			add_location(img4, file, 90, 10, 2078);
			add_location(figure4, file, 90, 2, 2070);
			attr_dev(div6, "class", "container image-gallery svelte-1abxzzq");
			add_location(div6, file, 86, 0, 1835);
		},
