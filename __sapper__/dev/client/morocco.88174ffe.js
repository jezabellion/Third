...
import { M as ModalNav } from './ModalNav.97df8dc8.js';
import { C as ChapterHeader } from './ChapterHeader.184f99bf.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t11 = claim_text(button_nodes, "View Menu");
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1ep9p8u");
			add_location(h1, file$3, 125, 8, 2763);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 124, 6, 2731);
			attr_dev(div1, "class", "shoes hero-body svelte-1ep9p8u");
			add_location(div1, file$3, 123, 4, 2695);
			attr_dev(div2, "class", "hero-image svelte-1ep9p8u");
			add_location(div2, file$3, 122, 2, 2666);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1ep9p8u");
			add_location(a0, file$3, 136, 14, 3060);
			add_location(li0, file$3, 136, 10, 3056);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1ep9p8u");
			add_location(a1, file$3, 137, 14, 3119);
			add_location(li1, file$3, 137, 10, 3115);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1ep9p8u");
			add_location(a2, file$3, 138, 14, 3177);
			add_location(li2, file$3, 138, 10, 3173);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1ep9p8u");
			add_location(a3, file$3, 139, 14, 3237);
			add_location(li3, file$3, 139, 10, 3233);
			attr_dev(ul, "class", "svelte-1ep9p8u");
			add_location(ul, file$3, 134, 8, 2983);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 133, 6, 2951);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1ep9p8u");
			add_location(nav, file$3, 132, 4, 2913);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1ep9p8u");
			add_location(div4, file$3, 131, 2, 2868);
			attr_dev(button, "class", "button is-white svelte-1ep9p8u");
			add_location(button, file$3, 148, 4, 3436);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 147, 2, 3393);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 146, 0, 3350);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
