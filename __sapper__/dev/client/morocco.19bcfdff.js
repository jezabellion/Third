...
import { C as ChapterHeader } from './ChapterHeader.567d5680.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1drgq9o");
			add_location(img, file$3, 33, 12, 867);
			attr_dev(figure, "class", "svelte-1drgq9o");
			add_location(figure, file$3, 33, 4, 859);
			attr_dev(div, "class", "container image-gallery svelte-1drgq9o");
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1drgq9o");
			add_location(img, file$3, 41, 12, 1054);
			attr_dev(figure, "class", "svelte-1drgq9o");
			add_location(figure, file$3, 41, 4, 1046);
			attr_dev(div, "class", "container image-gallery svelte-1drgq9o");
			add_location(div, file$3, 40, 2, 1004);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1drgq9o");
			add_location(img, file$3, 49, 12, 1241);
			attr_dev(figure, "class", "svelte-1drgq9o");
			add_location(figure, file$3, 49, 4, 1233);
			attr_dev(div, "class", "container image-gallery svelte-1drgq9o");
			add_location(div, file$3, 48, 2, 1191);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
