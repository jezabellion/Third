...
import { M as ModalNav, d as destination } from './ModalNav.110d8a78.js';
import { c as copy, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.b6dfac85.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 40, 6, 1128);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 39, 4, 1098);
			attr_dev(div1, "class", "hero-body svelte-wzpccu");
			add_location(div1, file$1, 38, 2, 1070);
			attr_dev(section, "class", section_class_value = "hero " + /*backgroundHero*/ ctx[1] + " is-transparent is-fullheight" + " svelte-wzpccu");
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*backgroundHero*/ 2 && section_class_value !== (section_class_value = "hero " + /*backgroundHero*/ ctx[1] + " is-transparent is-fullheight" + " svelte-wzpccu")) {
