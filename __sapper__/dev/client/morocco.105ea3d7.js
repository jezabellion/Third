...
import { M as ModalNav, d as destination } from './ModalNav.1c77828a.js';
import { c as copy, b as backgroundHero, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.1c555773.js';
			...
			if (dirty & /*photos*/ 0) {
				...
				for (i = 0; i < each_value_4.length; i += 1) {
					...
					if (each_blocks_4[i]) {
						...
						each_blocks_4[i].c();
						each_blocks_4[i].m(t3.parentNode, t3);
					}
				}
