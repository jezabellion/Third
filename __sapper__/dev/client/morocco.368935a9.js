...
import { M as ModalNav } from './ModalNav.b16fe18a.js';
import { C as ChapterHeader } from './ChapterHeader.45c43d44.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$3, 144, 2, 3393);
			attr_dev(div5, "class", "column has-text-centered\t");
			add_location(div5, file$3, 143, 0, 3351);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 142, 0, 3310);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
