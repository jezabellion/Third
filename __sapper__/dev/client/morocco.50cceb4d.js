...
import { M as ModalNav } from './ModalNav.8b2ee13a.js';
import { C as ChapterHeader } from './ChapterHeader.fd45aa91.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p0, "class", "svelte-abm6w7");
			add_location(p0, file$2, 27, 2, 590);
			attr_dev(p1, "class", "svelte-abm6w7");
			add_location(p1, file$2, 28, 2, 611);
			attr_dev(p2, "class", "svelte-abm6w7");
			add_location(p2, file$2, 29, 2, 626);
			attr_dev(div, "class", "container blurb svelte-abm6w7");
