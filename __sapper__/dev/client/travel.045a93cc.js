...
import { T as Truman } from './Truman.9bb2d86b.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 50, 12, 1167);
			add_location(figure, file$3, 50, 4, 1159);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 49, 2, 1117);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
