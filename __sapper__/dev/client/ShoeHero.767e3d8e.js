import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, q as binding_callbacks, r as bind, v as validate_slots, u as create_component, a as space, e as element, t as text, w as claim_component, g as claim_space, c as claim_element, b as children, f as detach_dev, h as claim_text, j as attr_dev, k as add_location, x as mount_component, m as insert_dev, n as append_dev, o as listen_dev, y as add_flush_callback, z as transition_in, A as transition_out, B as destroy_component, C as identity, D as set_data_dev, E as add_render_callback, F as create_in_transition, p as noop } from './client.fdbf72ee.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-y3fkcv");
			add_location(h1, file$1, 44, 8, 1130);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 43, 6, 1098);
			attr_dev(div1, "class", "hero-body svelte-y3fkcv");
			add_location(div1, file$1, 42, 4, 1068);
			attr_dev(section, "class", section_class_value = "" + (/*current*/ ctx[1] + " hero is-transparent is-fullheight" + " svelte-y3fkcv"));
			add_location(section, file$1, 38, 0, 949);
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*current*/ 2 && section_class_value !== (section_class_value = "" + (/*current*/ ctx[1] + " hero is-transparent is-fullheight" + " svelte-y3fkcv"))) {
