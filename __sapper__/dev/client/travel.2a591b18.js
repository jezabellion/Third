import { y as identity, S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, B as Bonkers, v as validate_slots, a as space, e as element, o as create_component, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, p as claim_component, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, r as mount_component, m as append_dev, u as transition_in, z as add_render_callback, A as create_in_transition, w as transition_out, x as destroy_component } from './client.8fb4e7ab.js';
import { T as Truman } from './Truman.864c4336.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 62, 6, 1250);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 61, 4, 1220);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file, 60, 2, 1192);
			...
			add_location(p0, file, 68, 2, 1368);
			attr_dev(p1, "class", "svelte-182jq4i");
			add_location(p1, file, 69, 2, 1490);
			attr_dev(p2, "class", "svelte-182jq4i");
			add_location(p2, file, 70, 2, 1505);
			attr_dev(div2, "class", "container blurb svelte-182jq4i");
			add_location(div2, file, 67, 0, 1336);
			...
			add_location(img0, file, 74, 10, 1584);
			add_location(figure0, file, 74, 2, 1576);
			attr_dev(div3, "class", "container image-gallery svelte-182jq4i");
			add_location(div3, file, 73, 0, 1536);
			attr_dev(h2, "class", "svelte-182jq4i");
			add_location(h2, file, 79, 4, 1706);
			attr_dev(p3, "class", "svelte-182jq4i");
			add_location(p3, file, 80, 4, 1733);
			attr_dev(div4, "class", "chapter-header svelte-182jq4i");
			add_location(div4, file, 78, 2, 1673);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 77, 0, 1647);
			...
			add_location(img1, file, 85, 10, 1811);
			add_location(figure1, file, 85, 2, 1803);
			...
			add_location(img2, file, 86, 10, 1876);
			add_location(figure2, file, 86, 2, 1868);
			...
			add_location(img3, file, 87, 10, 1941);
			add_location(figure3, file, 87, 2, 1933);
			...
			add_location(img4, file, 88, 10, 2006);
			add_location(figure4, file, 88, 2, 1998);
			attr_dev(div6, "class", "container image-gallery svelte-182jq4i");
			add_location(div6, file, 84, 0, 1763);
		},
		...
		i: function intro(local) {
			...
			if (!section_intro) {
				add_render_callback(() => {
					section_intro = create_in_transition(section, fade, { duration: 1000 });
					section_intro.start();
				});
			}
