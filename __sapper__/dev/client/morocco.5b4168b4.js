...
import { C as ChapterHeader } from './ChapterHeader.6ac2e573.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p0, "class", "svelte-1uuaivk");
			add_location(p0, file$2, 26, 2, 563);
			attr_dev(p1, "class", "svelte-1uuaivk");
			add_location(p1, file$2, 27, 2, 584);
			attr_dev(p2, "class", "svelte-1uuaivk");
			add_location(p2, file$2, 28, 2, 599);
			attr_dev(div, "class", "container blurb svelte-1uuaivk");
			add_location(div, file$2, 25, 0, 531);
		},
		m: function mount(target, anchor) {
