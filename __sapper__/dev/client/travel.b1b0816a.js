...
import { T as Truman } from './Truman.c6e495aa.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(h1_nodes, /*destination*/ ctx[0]);
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 27, 6, 1324);
			attr_dev(div0, "class", "container");
			add_location(div0, file$2, 26, 4, 1294);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file$2, 25, 2, 1266);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-fkqvyk");
			add_location(section, file$2, 21, 0, 1175);
		},
		m: function mount(target, anchor) {
...
// (40:0) {#each photosOne as photo, i}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 41, 11, 1010);
			add_location(figure, file$3, 41, 3, 1002);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 40, 1, 961);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(40:0) {#each photosOne as photo, i}",
		ctx
	});
...
// (48:0) {#each photosTwo as photo, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[6].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 49, 11, 1172);
			add_location(figure, file$3, 49, 3, 1164);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 48, 1, 1123);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(48:0) {#each photosTwo as photo, i}",
		ctx
	});
