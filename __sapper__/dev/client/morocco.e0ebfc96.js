...
import { M as ModalNav } from './ModalNav.a56c6b17.js';
import { C as ChapterHeader } from './ChapterHeader.7a2d8d12.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1u95bfe");
			add_location(h1, file$3, 114, 8, 2627);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 113, 6, 2595);
			attr_dev(div1, "class", "shoes hero-body svelte-1u95bfe");
			add_location(div1, file$3, 112, 4, 2559);
			attr_dev(div2, "class", "hero-image svelte-1u95bfe");
			add_location(div2, file$3, 111, 2, 2530);
			attr_dev(a0, "href", "morocco");
			attr_dev(a0, "class", "svelte-1u95bfe");
			add_location(a0, file$3, 125, 14, 2924);
			add_location(li0, file$3, 125, 10, 2920);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-1u95bfe");
			add_location(a1, file$3, 126, 14, 2983);
			add_location(li1, file$3, 126, 10, 2979);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-1u95bfe");
			add_location(a2, file$3, 127, 14, 3041);
			add_location(li2, file$3, 127, 10, 3037);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-1u95bfe");
			add_location(a3, file$3, 128, 14, 3101);
			add_location(li3, file$3, 128, 10, 3097);
			attr_dev(ul, "class", "svelte-1u95bfe");
			add_location(ul, file$3, 123, 8, 2847);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 122, 6, 2815);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-1u95bfe");
			add_location(nav, file$3, 121, 4, 2777);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-1u95bfe");
			add_location(div4, file$3, 120, 2, 2732);
		},
		m: function mount(target, anchor) {
