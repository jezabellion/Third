...
import { M as ModalNav } from './ModalNav.96cb701d.js';
import { C as ChapterHeader } from './ChapterHeader.f6c7e8c6.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 22, 8, 635);
			attr_dev(a0, "class", "navbar-item");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 21, 6, 593);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-2brar");
			add_location(span0, file, 25, 8, 867);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-2brar");
			add_location(span1, file, 26, 8, 908);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-2brar");
			add_location(span2, file, 27, 8, 949);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-2brar");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 24, 6, 728);
			attr_dev(div0, "class", "navbar-brand svelte-2brar");
			add_location(div0, file, 20, 4, 560);
			attr_dev(a2, "class", "navbar-item");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 34, 10, 1132);
			attr_dev(a3, "class", "navbar-item");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 35, 10, 1202);
			attr_dev(a4, "class", "navbar-item");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 36, 10, 1273);
			attr_dev(a5, "class", "navbar-item");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 37, 10, 1342);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 33, 8, 1091);
			attr_dev(div2, "class", "navbar-item");
			add_location(div2, file, 32, 6, 1057);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 31, 4, 1009);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 19, 2, 510);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 18, 0, 484);
		},
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-tythwm");
			add_location(h1, file$1, 35, 6, 902);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 34, 4, 872);
			attr_dev(div1, "class", "hero-body svelte-tythwm");
			add_location(div1, file$1, 33, 2, 844);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-tythwm");
			add_location(section, file$1, 29, 0, 746);
		},
