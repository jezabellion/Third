...
import { C as ChapterHeader } from './ChapterHeader.41db96df.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p0, "class", "svelte-1ravpcc");
			add_location(p0, file$2, 26, 2, 567);
			attr_dev(p1, "class", "svelte-1ravpcc");
			add_location(p1, file$2, 27, 2, 588);
			attr_dev(p2, "class", "svelte-1ravpcc");
			add_location(p2, file$2, 28, 2, 603);
			attr_dev(div, "class", "container blurb svelte-1ravpcc");
