...
import { M as ModalNav } from './ModalNav.88a57b0b.js';
import { C as ChapterHeader } from './ChapterHeader.1d0e63b0.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 28, 8, 701);
			attr_dev(a0, "class", "navbar-item svelte-18ybw7g");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 27, 6, 659);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-18ybw7g");
			add_location(span0, file, 31, 8, 933);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-18ybw7g");
			add_location(span1, file, 32, 8, 974);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-18ybw7g");
			add_location(span2, file, 33, 8, 1015);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-18ybw7g");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 30, 6, 794);
			attr_dev(div0, "class", "navbar-brand svelte-18ybw7g");
			add_location(div0, file, 26, 4, 626);
			attr_dev(a2, "class", "navbar-item svelte-18ybw7g");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 40, 10, 1198);
			attr_dev(a3, "class", "navbar-item svelte-18ybw7g");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 41, 10, 1268);
			attr_dev(a4, "class", "navbar-item svelte-18ybw7g");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 42, 10, 1339);
			attr_dev(a5, "class", "navbar-item svelte-18ybw7g");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 43, 10, 1408);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 39, 8, 1157);
			attr_dev(div2, "class", "navbar-item svelte-18ybw7g");
			add_location(div2, file, 38, 6, 1123);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 37, 4, 1075);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 25, 2, 576);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 24, 0, 550);
		},
