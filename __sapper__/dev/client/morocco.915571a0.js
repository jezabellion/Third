...
import { M as ModalNav } from './ModalNav.3c1bad06.js';
import { C as ChapterHeader } from './ChapterHeader.5d0db5e0.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 20, 8, 569);
			attr_dev(a0, "class", "navbar-item");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 19, 6, 527);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-1vi6r5o");
			add_location(span0, file, 23, 8, 801);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-1vi6r5o");
			add_location(span1, file, 24, 8, 842);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-1vi6r5o");
			add_location(span2, file, 25, 8, 883);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-1vi6r5o");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 22, 6, 662);
			attr_dev(div0, "class", "navbar-brand svelte-1vi6r5o");
			add_location(div0, file, 18, 4, 494);
			attr_dev(a2, "class", "navbar-item");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 32, 10, 1066);
			attr_dev(a3, "class", "navbar-item");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 33, 10, 1136);
			attr_dev(a4, "class", "navbar-item");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 34, 10, 1207);
			attr_dev(a5, "class", "navbar-item");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 35, 10, 1276);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 31, 8, 1025);
			attr_dev(div2, "class", "navbar-item");
			add_location(div2, file, 30, 6, 991);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 29, 4, 943);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 17, 2, 444);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 16, 0, 418);
		},
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 35, 6, 916);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 34, 4, 886);
			attr_dev(div1, "class", "hero-body svelte-1uczkwb");
			add_location(div1, file$1, 33, 2, 858);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-1uczkwb");
