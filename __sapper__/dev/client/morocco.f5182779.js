...
import { C as ChapterHeader } from './ChapterHeader.317d0410.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 27, 12, 704);
			attr_dev(figure, "class", "svelte-fl2165");
			add_location(figure, file$3, 27, 4, 696);
			attr_dev(div, "class", "container image-gallery");
			add_location(div, file$3, 26, 2, 654);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-fl2165");
			add_location(img, file$3, 35, 12, 891);
			attr_dev(figure, "class", "svelte-fl2165");
			add_location(figure, file$3, 35, 4, 883);
			attr_dev(div, "class", "container image-gallery");
			add_location(div, file$3, 34, 2, 841);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-fl2165");
			add_location(img, file$3, 43, 12, 1078);
			attr_dev(figure, "class", "svelte-fl2165");
			add_location(figure, file$3, 43, 4, 1070);
			attr_dev(div, "class", "container image-gallery");
			add_location(div, file$3, 42, 2, 1028);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
