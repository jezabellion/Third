...
import { M as ModalNav, d as destination } from './ModalNav.641ba350.js';
import { c as copy, b as backgroundHero, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.01730202.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$5, 99, 12, 2343);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$5, 99, 4, 2335);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$5, 98, 2, 2293);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
