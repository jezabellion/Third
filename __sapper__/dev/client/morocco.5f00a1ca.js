...
import { M as ModalNav, d as destination, b as backgroundHero } from './ModalNav.380764ca.js';
import { c as copy, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.6e54d7f3.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 33, 6, 909);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 32, 4, 879);
			attr_dev(div1, "class", "hero-body svelte-2zr7eb");
			add_location(div1, file$1, 31, 2, 851);
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$4, 34, 12, 959);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 34, 4, 951);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 33, 2, 909);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 42, 12, 1147);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 42, 4, 1139);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 41, 2, 1097);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 50, 12, 1335);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 50, 4, 1327);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 49, 2, 1285);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_fragment$4(ctx) {
	...
	const hero = new Hero({
			props: {
				backgroundHero: backgroundHero.morocco,
