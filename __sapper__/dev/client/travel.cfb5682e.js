...
import { T as Truman } from './Truman.8ccf389a.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$2, 22, 4, 488);
			attr_dev(p, "class", "svelte-p4xdmg");
			add_location(p, file$2, 23, 4, 514);
			attr_dev(div0, "class", "chapter-header svelte-p4xdmg");
			add_location(div0, file$2, 21, 2, 455);
			attr_dev(div1, "class", "container");
			add_location(div1, file$2, 20, 0, 429);
		},
		m: function mount(target, anchor) {
