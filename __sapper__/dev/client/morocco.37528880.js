...
import { M as ModalNav, d as destination } from './ModalNav.c0502477.js';
import { c as copy, b as backgroundHero, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.3b4dd6ee.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 37, 6, 1060);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 36, 4, 1030);
			attr_dev(div1, "class", "hero-body svelte-o2xj6m");
			add_location(div1, file$1, 35, 2, 1002);
		...
		i: function intro(local) {
			...
			if (!section_intro) {
				add_render_callback(() => {
					section_intro = create_in_transition(section, fade, { duration: 2000 });
					section_intro.start();
				});
			}
