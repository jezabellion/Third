import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, q as binding_callbacks, r as bind, v as validate_slots, u as create_component, a as space, e as element, t as text, x as claim_component, g as claim_space, c as claim_element, b as children, f as detach_dev, h as claim_text, j as attr_dev, k as add_location, y as mount_component, m as insert_dev, n as append_dev, o as listen_dev, z as add_flush_callback, A as transition_in, B as transition_out, C as destroy_component, D as identity, E as set_data_dev, F as add_render_callback, G as create_in_transition, p as noop } from './client.25833800.js';
import { M as ModalNav, d as destination } from './ModalNav.b6cb676f.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-c8b24w");
			add_location(h1, file$1, 43, 8, 1102);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 42, 6, 1070);
			attr_dev(div1, "class", "hero-body svelte-c8b24w");
			add_location(div1, file$1, 41, 4, 1040);
			attr_dev(section, "class", section_class_value = "" + (/*current*/ ctx[1] + " hero is-transparent is-fullheight" + " svelte-c8b24w"));
			add_location(section, file$1, 37, 0, 921);
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*current*/ 2 && section_class_value !== (section_class_value = "" + (/*current*/ ctx[1] + " hero is-transparent is-fullheight" + " svelte-c8b24w"))) {
