...
import { T as Truman } from './Truman.f2366b43.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[6].alt);
			attr_dev(img, "class", "svelte-2ikc7i");
			add_location(img, file$2, 71, 11, 1632);
			add_location(figure, file$2, 71, 3, 1624);
			attr_dev(div, "class", "container image-gallery svelte-2ikc7i");
			add_location(div, file$2, 70, 1, 1583);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
