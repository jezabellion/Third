...
import { M as ModalNav } from './ModalNav.3fefc9a5.js';
import { C as ChapterHeader } from './ChapterHeader.c1e3a612.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			var a4_nodes = children(a4);
			t10 = claim_text(a4_nodes, "Cunny fluff");
			a4_nodes.forEach(detach_dev);
		...
		h: function hydrate() {
			...
			add_location(a4, file$3, 143, 2, 3345);
			attr_dev(div5, "class", "is-mobile");
