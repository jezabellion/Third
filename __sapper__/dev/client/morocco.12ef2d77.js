...
import { M as ModalNav } from './ModalNav.048611a1.js';
import { C as ChapterHeader } from './ChapterHeader.07b1b54e.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 30, 8, 723);
			attr_dev(a0, "class", "navbar-item svelte-dl07ys");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 29, 6, 681);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-dl07ys");
			add_location(span0, file, 33, 8, 955);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-dl07ys");
			add_location(span1, file, 34, 8, 996);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-dl07ys");
			add_location(span2, file, 35, 8, 1037);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-dl07ys");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 32, 6, 816);
			attr_dev(div0, "class", "navbar-brand svelte-dl07ys");
			add_location(div0, file, 28, 4, 648);
			attr_dev(a2, "class", "navbar-item is-active svelte-dl07ys");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 42, 10, 1220);
			attr_dev(a3, "class", "navbar-item svelte-dl07ys");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 43, 10, 1300);
			attr_dev(a4, "class", "navbar-item svelte-dl07ys");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 44, 10, 1371);
			attr_dev(a5, "class", "navbar-item svelte-dl07ys");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 45, 10, 1440);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 41, 8, 1179);
			attr_dev(div2, "class", "navbar-item svelte-dl07ys");
			add_location(div2, file, 40, 6, 1145);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 39, 4, 1097);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 27, 2, 598);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 26, 0, 572);
		},
