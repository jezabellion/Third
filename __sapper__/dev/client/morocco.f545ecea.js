...
import { M as ModalNav } from './ModalNav.815444d0.js';
import { C as ChapterHeader } from './ChapterHeader.a3cb2a05.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 26, 8, 641);
			attr_dev(a0, "class", "navbar-item svelte-uvm27q");
			attr_dev(a0, "href", "./");
			add_location(a0, file, 25, 6, 599);
			attr_dev(span0, "aria-hidden", "true");
			attr_dev(span0, "class", "svelte-uvm27q");
			add_location(span0, file, 29, 8, 873);
			attr_dev(span1, "aria-hidden", "true");
			attr_dev(span1, "class", "svelte-uvm27q");
			add_location(span1, file, 30, 8, 914);
			attr_dev(span2, "aria-hidden", "true");
			attr_dev(span2, "class", "svelte-uvm27q");
			add_location(span2, file, 31, 8, 955);
			attr_dev(a1, "role", "button");
			attr_dev(a1, "class", "navbar-burger is-hidden-tablet svelte-uvm27q");
			attr_dev(a1, "aria-label", "menu");
			attr_dev(a1, "aria-expanded", "false");
			add_location(a1, file, 28, 6, 734);
			attr_dev(div0, "class", "navbar-brand svelte-uvm27q");
			add_location(div0, file, 24, 4, 566);
			attr_dev(a2, "class", "navbar-item svelte-uvm27q");
			attr_dev(a2, "href", "morocco");
			add_location(a2, file, 38, 10, 1138);
			attr_dev(a3, "class", "navbar-item svelte-uvm27q");
			attr_dev(a3, "href", "istanbul");
			add_location(a3, file, 39, 10, 1208);
			attr_dev(a4, "class", "navbar-item svelte-uvm27q");
			attr_dev(a4, "href", "peru");
			add_location(a4, file, 40, 10, 1279);
			attr_dev(a5, "class", "navbar-item svelte-uvm27q");
			attr_dev(a5, "href", "russia");
			add_location(a5, file, 41, 10, 1348);
			attr_dev(div1, "class", "field is-grouped");
			add_location(div1, file, 37, 8, 1097);
			attr_dev(div2, "class", "navbar-item svelte-uvm27q");
			add_location(div2, file, 36, 6, 1063);
			attr_dev(div3, "class", "navbar-end is-hidden-mobile");
			add_location(div3, file, 35, 4, 1015);
			attr_dev(nav, "class", "navbar is-transparent is-spaced");
			add_location(nav, file, 23, 2, 516);
			attr_dev(div4, "class", "hero-head");
			add_location(div4, file, 22, 0, 490);
		},
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p0, "class", "svelte-ycnhmb");
			add_location(p0, file$2, 26, 2, 566);
			attr_dev(p1, "class", "svelte-ycnhmb");
			add_location(p1, file$2, 27, 2, 587);
			attr_dev(p2, "class", "svelte-ycnhmb");
			add_location(p2, file$2, 28, 2, 602);
			attr_dev(div, "class", "container blurb svelte-ycnhmb");
			add_location(div, file$2, 25, 0, 534);
		},
		m: function mount(target, anchor) {
