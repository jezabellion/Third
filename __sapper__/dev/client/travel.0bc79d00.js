...
import { T as Truman } from './Truman.2c993743.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 42, 12, 1021);
			add_location(figure, file$3, 42, 4, 1013);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 41, 2, 971);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[2].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 50, 12, 1208);
			add_location(figure, file$3, 50, 4, 1200);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 49, 2, 1158);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
