...
import { M as ModalNav } from './ModalNav.b6f31fe4.js';
import { C as ChapterHeader } from './ChapterHeader.ee5d4b9e.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-kl6v43");
			add_location(h1, file$3, 93, 8, 1939);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 92, 6, 1907);
			attr_dev(div1, "class", "shoes hero-body svelte-kl6v43");
			add_location(div1, file$3, 91, 4, 1871);
			attr_dev(div2, "class", "hero-image svelte-kl6v43");
			add_location(div2, file$3, 90, 2, 1842);
			attr_dev(a0, "class", "is-active svelte-kl6v43");
			attr_dev(a0, "href", "morocco");
			add_location(a0, file$3, 104, 14, 2236);
			add_location(li0, file$3, 104, 10, 2232);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-kl6v43");
			add_location(a1, file$3, 105, 14, 2313);
			add_location(li1, file$3, 105, 10, 2309);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-kl6v43");
			add_location(a2, file$3, 106, 14, 2371);
			add_location(li2, file$3, 106, 10, 2367);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-kl6v43");
			add_location(a3, file$3, 107, 14, 2431);
			add_location(li3, file$3, 107, 10, 2427);
			attr_dev(ul, "class", "svelte-kl6v43");
			add_location(ul, file$3, 102, 8, 2159);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 101, 6, 2127);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-kl6v43");
			add_location(nav, file$3, 100, 4, 2089);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-kl6v43");
			add_location(div4, file$3, 99, 2, 2044);
			attr_dev(button, "class", "button is-white svelte-kl6v43");
