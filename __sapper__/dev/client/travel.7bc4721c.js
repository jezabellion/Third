...
import { T as Truman } from './Truman.563429c8.js';
...
// (27:1) {#each photosOne as photo, i}
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 28, 12, 755);
			add_location(figure, file$3, 28, 4, 747);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 27, 2, 705);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(27:1) {#each photosOne as photo, i}",
		ctx
	});
...
// (35:1) {#each photosTwo as photo, i}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 36, 12, 950);
			add_location(figure, file$3, 36, 4, 942);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 35, 2, 900);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(35:1) {#each photosTwo as photo, i}",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1806rlb");
			add_location(img, file$3, 44, 12, 1145);
			add_location(figure, file$3, 44, 4, 1137);
			attr_dev(div, "class", "container image-gallery svelte-1806rlb");
			add_location(div, file$3, 43, 2, 1095);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_fragment$3(ctx) {
	...
	const chapterheader0 = new ChapterHeader({
			props: { "chapter-header": chapterOne },
			$$inline: true
		});
	...
	const chapterheader1 = new ChapterHeader({
			props: { "chapter-header": chapterTwo },
			$$inline: true
		});
