...
import { C as ChapterHeader } from './ChapterHeader.96aabe63.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$2, 20, 2, 438);
			attr_dev(p1, "class", "svelte-1gn6av2");
			add_location(p1, file$2, 21, 2, 459);
			attr_dev(p2, "class", "svelte-1gn6av2");
			add_location(p2, file$2, 22, 2, 474);
			attr_dev(div, "class", "container blurb svelte-1gn6av2");
			add_location(div, file$2, 19, 0, 406);
		},
		m: function mount(target, anchor) {
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-12pp5uc");
			add_location(img, file$3, 33, 12, 873);
			attr_dev(figure, "class", "svelte-12pp5uc");
			add_location(figure, file$3, 33, 4, 865);
			attr_dev(div, "class", "container image-gallery svelte-12pp5uc");
			add_location(div, file$3, 32, 2, 823);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-12pp5uc");
			add_location(img, file$3, 41, 12, 1060);
			attr_dev(figure, "class", "svelte-12pp5uc");
			add_location(figure, file$3, 41, 4, 1052);
			attr_dev(div, "class", "container image-gallery svelte-12pp5uc");
			add_location(div, file$3, 40, 2, 1010);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-12pp5uc");
			add_location(img, file$3, 49, 12, 1247);
			attr_dev(figure, "class", "svelte-12pp5uc");
			add_location(figure, file$3, 49, 4, 1239);
			attr_dev(div, "class", "container image-gallery svelte-12pp5uc");
			add_location(div, file$3, 48, 2, 1197);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
