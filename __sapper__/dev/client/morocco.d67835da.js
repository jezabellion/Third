...
import { M as ModalNav } from './ModalNav.6f6667e8.js';
import { C as ChapterHeader } from './ChapterHeader.cf690e5f.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-vi31pu");
			add_location(h1, file$3, 92, 8, 1896);
			attr_dev(div0, "class", "container");
			add_location(div0, file$3, 91, 6, 1864);
			attr_dev(div1, "class", "shoes hero-body svelte-vi31pu");
			add_location(div1, file$3, 90, 4, 1828);
			attr_dev(div2, "class", "hero-image svelte-vi31pu");
			add_location(div2, file$3, 89, 2, 1799);
			attr_dev(a0, "class", "is-active svelte-vi31pu");
			attr_dev(a0, "href", "morocco");
			add_location(a0, file$3, 103, 14, 2193);
			add_location(li0, file$3, 103, 10, 2189);
			attr_dev(a1, "href", "travel");
			attr_dev(a1, "class", "svelte-vi31pu");
			add_location(a1, file$3, 104, 14, 2270);
			add_location(li1, file$3, 104, 10, 2266);
			attr_dev(a2, "href", "travel");
			attr_dev(a2, "class", "svelte-vi31pu");
			add_location(a2, file$3, 105, 14, 2328);
			add_location(li2, file$3, 105, 10, 2324);
			attr_dev(a3, "href", "travel");
			attr_dev(a3, "class", "svelte-vi31pu");
			add_location(a3, file$3, 106, 14, 2388);
			add_location(li3, file$3, 106, 10, 2384);
			attr_dev(ul, "class", "svelte-vi31pu");
			add_location(ul, file$3, 101, 8, 2116);
			attr_dev(div3, "class", "container");
			add_location(div3, file$3, 100, 6, 2084);
			attr_dev(nav, "class", "tabs is-fullwidth svelte-vi31pu");
			add_location(nav, file$3, 99, 4, 2046);
			attr_dev(div4, "class", "hero-foot is-hidden-mobile svelte-vi31pu");
			add_location(div4, file$3, 98, 2, 2001);
			attr_dev(button, "class", "button is-white svelte-vi31pu");
			add_location(button, file$3, 115, 4, 2587);
			attr_dev(div5, "class", "column has-text-centered");
			add_location(div5, file$3, 114, 2, 2544);
			attr_dev(div6, "class", "container is-hidden-tablet");
			add_location(div6, file$3, 113, 0, 2501);
		},
		m: function mount(target, anchor, remount) {
			mount_component(modalnav, target, anchor);
			insert_dev(target, t0, anchor);
