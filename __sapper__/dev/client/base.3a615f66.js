import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.901a827c.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 64, 12, 1317);
			attr_dev(a0, "class", "navbar-item");
			add_location(a0, file, 63, 10, 1281);
			add_location(span0, file, 67, 12, 1486);
			add_location(span1, file, 68, 12, 1512);
			add_location(span2, file, 69, 12, 1538);
			attr_dev(span3, "class", "navbar-burger burger");
			attr_dev(span3, "data-target", "navbarMenuHeroC");
			add_location(span3, file, 66, 10, 1408);
			attr_dev(div0, "class", "navbar-brand");
			add_location(div0, file, 62, 8, 1244);
			attr_dev(div1, "class", "container");
			add_location(div1, file, 61, 6, 1212);
			attr_dev(header, "class", "navbar");
			add_location(header, file, 60, 4, 1182);
			attr_dev(div2, "class", "hero-head");
			add_location(div2, file, 59, 2, 1154);
			attr_dev(h1, "class", "title svelte-9vyae0");
			add_location(h1, file, 82, 8, 1788);
			attr_dev(div3, "class", "container has-text-centered");
			add_location(div3, file, 81, 6, 1738);
			attr_dev(div4, "class", "shoes hero-body svelte-9vyae0");
			add_location(div4, file, 80, 4, 1702);
			attr_dev(div5, "class", "hero-image svelte-9vyae0");
			add_location(div5, file, 79, 2, 1673);
			add_location(a1, file, 94, 32, 2074);
			attr_dev(li0, "class", "is-active");
			add_location(li0, file, 94, 10, 2052);
			add_location(a2, file, 95, 14, 2109);
			add_location(li1, file, 95, 10, 2105);
			add_location(a3, file, 96, 14, 2145);
			add_location(li2, file, 96, 10, 2141);
			add_location(a4, file, 97, 14, 2176);
			add_location(li3, file, 97, 10, 2172);
			add_location(a5, file, 98, 14, 2211);
			add_location(li4, file, 98, 10, 2207);
			add_location(a6, file, 99, 14, 2248);
			add_location(li5, file, 99, 10, 2244);
			attr_dev(ul, "class", "svelte-9vyae0");
			add_location(ul, file, 93, 8, 2037);
			attr_dev(div6, "class", "container");
			add_location(div6, file, 92, 6, 2005);
			attr_dev(nav, "class", "tabs is-boxed is-fullwidth");
			add_location(nav, file, 91, 4, 1958);
			attr_dev(div7, "class", "hero-foot svelte-9vyae0");
			add_location(div7, file, 90, 2, 1930);
			attr_dev(section, "class", "hero is-success is-fullheight svelte-9vyae0");
			add_location(section, file, 57, 0, 1060);
		},
