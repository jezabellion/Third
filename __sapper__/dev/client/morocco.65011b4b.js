...
import { M as ModalNav, d as destination } from './ModalNav.f720a9d2.js';
import { c as copy, b as backgroundHero$1, C as ChapterHeader, a as chapter, p as photos } from './ChapterHeader.0e29dfff.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 35, 6, 998);
			attr_dev(div0, "class", "container");
			add_location(div0, file$1, 34, 4, 968);
			attr_dev(div1, "class", "hero-body svelte-1wp20ao");
			add_location(div1, file$1, 33, 2, 940);
			set_style(section, "background-image", backgroundHero);
...
function create_fragment$5(ctx) {
	...
	const hero = new Hero({
			props: {
				backgroundHero: backgroundHero$1,
