...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 63, 6, 1274);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 62, 4, 1244);
			attr_dev(div1, "class", "hero-body");
			add_location(div1, file, 61, 2, 1216);
			attr_dev(section, "class", "hero is-link is-fullheight svelte-1abxzzq");
			add_location(section, file, 57, 0, 1126);
			attr_dev(p0, "class", "svelte-1abxzzq");
			add_location(p0, file, 69, 2, 1392);
			attr_dev(p1, "class", "svelte-1abxzzq");
			add_location(p1, file, 70, 2, 1514);
			attr_dev(p2, "class", "svelte-1abxzzq");
			add_location(p2, file, 71, 2, 1529);
			attr_dev(div2, "class", "container blurb svelte-1abxzzq");
			add_location(div2, file, 68, 0, 1360);
			...
			add_location(img0, file, 75, 10, 1608);
			add_location(figure0, file, 75, 2, 1600);
			attr_dev(div3, "class", "container image-gallery svelte-1abxzzq");
			add_location(div3, file, 74, 0, 1560);
			attr_dev(h2, "class", "svelte-1abxzzq");
			add_location(h2, file, 80, 4, 1730);
			attr_dev(p3, "class", "svelte-1abxzzq");
			add_location(p3, file, 81, 4, 1757);
			attr_dev(div4, "class", "chapter-header svelte-1abxzzq");
			add_location(div4, file, 79, 2, 1697);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 78, 0, 1671);
			...
			add_location(img1, file, 86, 10, 1835);
			add_location(figure1, file, 86, 2, 1827);
			...
			add_location(img2, file, 87, 10, 1900);
			add_location(figure2, file, 87, 2, 1892);
			...
			add_location(img3, file, 88, 10, 1965);
			add_location(figure3, file, 88, 2, 1957);
			...
			add_location(img4, file, 89, 10, 2030);
			add_location(figure4, file, 89, 2, 2022);
			attr_dev(div6, "class", "container image-gallery svelte-1abxzzq");
			add_location(div6, file, 85, 0, 1787);
		},
