...
import { M as ModalNav } from './ModalNav.0bb54760.js';
import { C as ChapterHeader } from './ChapterHeader.c66d15cf.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$4, 34, 12, 953);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 34, 4, 945);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 33, 2, 903);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 42, 12, 1140);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 42, 4, 1132);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 41, 2, 1090);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "alt", img_alt_value = /*photo*/ ctx[1].alt);
			attr_dev(img, "class", "svelte-1u9i392");
			add_location(img, file$4, 50, 12, 1327);
			attr_dev(figure, "class", "svelte-1u9i392");
			add_location(figure, file$4, 50, 4, 1319);
			attr_dev(div, "class", "container image-gallery svelte-1u9i392");
			add_location(div, file$4, 49, 2, 1277);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, figure);
...
function create_fragment$4(ctx) {
	...
	const blurb_1 = new Blurb({
			props: { selected, blurbCopy: blurb.morocco },
			$$inline: true
		});
