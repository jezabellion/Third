...
const css$3 = {
	code: "h1.svelte-2430k5.svelte-2430k5{font-family:'Engagement', cursive;font-size:8rem;text-align:center;color:white}@media screen and (max-width: 1023px){.hero-body.svelte-2430k5 h1.svelte-2430k5{font-size:6rem;letter-spacing:-4px}}",
	map: "{\"version\":3,\"file\":\"Hero.svelte\",\"sources\":[\"Hero.svelte\"],\"sourcesContent\":[\"<script>\\n  import TravelPageNav from '../components/TravelPageNav.svelte';\\n  import { destination } from '../routes/data.js';\\n  import { fade } from 'svelte/transition';\\n\\tlet visible = true;\\n  // import {  } from '../routes/data.js';\\n  export let destHead;\\n  let backgroundHero = 'url(../images/morocco-thumb.jpg);'\\n</script>\\n\\n<style media=\\\"screen\\\" lang=\\\"scss\\\">h1 {\\n  font-family: 'Engagement', cursive;\\n  font-size: 8rem;\\n  text-align: center;\\n  color: white; }\\n\\n@media screen and (max-width: 1023px) {\\n  .hero-body h1 {\\n    font-size: 6rem;\\n    letter-spacing: -4px; } }\\n/*# sourceMappingURL=src/components/Hero.svelte.map */</style>\\n\\n<section style=\\\"background-image: {backgroundHero}\\\" class=\\\"hero is-transparent is-fullheight\\\">\\n\\n\\t<TravelPageNav/>\\n\\n  <div class=\\\"hero-body\\\">\\n    <div class=\\\"container\\\">\\n      <h1 in:fade=\\\"{{ duration: 2000 }}\\\">{destHead}</h1>\\n    </div>\\n  </div>\\n</section>\\n\"],\"names\":[],\"mappings\":\"AAUkC,EAAE,4BAAC,CAAC,AACpC,WAAW,CAAE,YAAY,CAAC,CAAC,OAAO,CAClC,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,MAAM,CAClB,KAAK,CAAE,KAAK,AAAE,CAAC,AAEjB,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,wBAAU,CAAC,EAAE,cAAC,CAAC,AACb,SAAS,CAAE,IAAI,CACf,cAAc,CAAE,IAAI,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section style="${"background-image: " + escape(backgroundHero)}" class="${"hero is-transparent is-fullheight"}">${validate_component(TravelPageNav, "TravelPageNav").$$render($$result, {}, {}, {})}

  <div class="${"hero-body svelte-2430k5"}"><div class="${"container"}"><h1 class="${"svelte-2430k5"}">${escape(destHead)}</h1></div></div></section>`;
});
