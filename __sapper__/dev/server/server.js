...
const photos$2 = {
  // Intro
   one: [
      { src: 'images/russia/a-photo_1.jpg', alt: 'yup' },
...
<div class="${"travelPage"}">${validate_component(Hero, "Hero").$$render(
	...
	${validate_component(Blurb, "Blurb").$$render(
		...
		${each(photos$2.eight, (photo, i) => `<div class="${"container image-gallery"}"><figure><img${add_attribute("src", photo.src, 0)}${add_attribute("alt", photo.alt, 0)}></figure>
			</div>`)}
