...
const Blurb = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <p class="${"svelte-oqf5m0"}">${escape(TravlerCopy)}</p></div>`;
});
...
<div class="${"travelPage"}">${validate_component(Hero, "Hero").$$render(
	...
	${validate_component(Blurb, "Blurb").$$render(
		...
		${validate_component(ChapterHeader, "ChapterHeader").$$render($$result, { title: chapter$3.one }, {}, {})}
		...
		${each(photos$3.five, (photo, i) => `<div class="${"container image-gallery"}"><figure><img${add_attribute("src", photo.src, 0)}${add_attribute("alt", photo.alt, 0)}></figure>
			</div>`)}
