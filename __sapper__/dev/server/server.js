...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(current) + " hero is-transparent is-fullheight" + " svelte-1pno2w"}">${validate_component(TravelPageNav, "TravelPageNav").$$render($$result, {}, {}, {})}

    <div class="${"hero-body svelte-1pno2w"}"><div class="${"container"}"><h1 class="${"svelte-1pno2w"}">${escape(destHead)}</h1></div></div></section>`;
});
