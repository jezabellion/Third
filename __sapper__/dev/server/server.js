...
const css = {
	code: ".modal.svelte-d5gq5r.svelte-d5gq5r{margin:1rem}.modal-content.svelte-d5gq5r.svelte-d5gq5r{overflow:hidden}.modal.svelte-d5gq5r a.svelte-d5gq5r{font-size:1.25rem;color:white;font-family:'Lato', sans-serif;font-weight:bold}.modal.svelte-d5gq5r a.svelte-d5gq5r:hover{opacity:50%}.modal.svelte-d5gq5r .is-selected.svelte-d5gq5r{text-decoration:line-through}",
	map: "{\"version\":3,\"file\":\"ModalNav.svelte\",\"sources\":[\"ModalNav.svelte\"],\"sourcesContent\":[\"<script>\\n  import { destination } from '../routes/morocco.js';\\n  export let showModal = false;\\n</script>\\n\\n<style>\\n  .modal {\\n    margin: 1rem;\\n  }\\n  .modal-content {\\n    overflow: hidden;\\n  }\\n  .modal a {\\n    font-size: 1.25rem;\\n    color: white;\\n    font-family: 'Lato', sans-serif;\\n    font-weight: bold;\\n  }\\n  .modal a:hover {\\n    opacity: 50%;\\n  }\\n  .modal .is-selected {\\n    text-decoration:line-through;\\n  }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<div class:is-active={showModal} class=\\\"modal is-clipped\\\">\\n  <div class=\\\"modal-background\\\"></div>\\n  <div class=\\\"modal-content\\\">\\n    <div class=\\\"container\\\">\\n        <div class=\\\"columns has-text-centered\\\">\\n          <div class=\\\"column\\\">\\n            <a class=\\\"is-selected\\\" href=\\\"morocco\\\">{destination.one}</a>\\n          </div>\\n          <div class=\\\"column\\\">\\n            <a href=\\\"morocco\\\">{destination.two}</a>\\n          </div>\\n          <div class=\\\"column\\\">\\n            <a href=\\\"peru\\\">Peru</a>\\n          </div>\\n          <div class=\\\"column\\\">\\n            <a href=\\\"russia\\\">Russia</a>\\n          </div>\\n        </div>\\n      </div>\\n      <button on:click={() => showModal = false} class=\\\"modal-close is-large\\\" aria-label=\\\"close\\\"></button>\\n    </div>\\n  </div>\\n\"],\"names\":[],\"mappings\":\"AAME,MAAM,4BAAC,CAAC,AACN,MAAM,CAAE,IAAI,AACd,CAAC,AACD,cAAc,4BAAC,CAAC,AACd,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,oBAAM,CAAC,CAAC,cAAC,CAAC,AACR,SAAS,CAAE,OAAO,CAClB,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,MAAM,CAAC,CAAC,UAAU,CAC/B,WAAW,CAAE,IAAI,AACnB,CAAC,AACD,oBAAM,CAAC,eAAC,MAAM,AAAC,CAAC,AACd,OAAO,CAAE,GAAG,AACd,CAAC,AACD,oBAAM,CAAC,YAAY,cAAC,CAAC,AACnB,gBAAgB,YAAY,AAC9B,CAAC\"}"
};
...
const ModalNav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${["modal is-clipped svelte-d5gq5r", showModal ? "is-active" : ""].join(" ").trim()}"><div class="${"modal-background"}"></div>
  <div class="${"modal-content svelte-d5gq5r"}"><div class="${"container"}"><div class="${"columns has-text-centered"}"><div class="${"column"}"><a class="${"is-selected svelte-d5gq5r"}" href="${"morocco"}">${escape(destination.one)}</a></div>
          <div class="${"column"}"><a href="${"morocco"}" class="${"svelte-d5gq5r"}">${escape(destination.two)}</a></div>
          <div class="${"column"}"><a href="${"peru"}" class="${"svelte-d5gq5r"}">Peru</a></div>
          <div class="${"column"}"><a href="${"russia"}" class="${"svelte-d5gq5r"}">Russia</a></div></div></div>
