...
const css = {
	code: "h1.svelte-13l94pn,figure.svelte-13l94pn,p.svelte-13l94pn{text-align:center;margin:0 auto}h1.svelte-13l94pn{font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}figure.svelte-13l94pn{margin:0 0 1em 0}img.svelte-13l94pn{width:100%;max-width:400px;margin:0 0 1em 0}p.svelte-13l94pn{margin:1em auto}@media(min-width: 480px){h1.svelte-13l94pn{font-size:4em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<style>\\n\\th1, figure, p {\\n\\t\\ttext-align: center;\\n\\t\\tmargin: 0 auto;\\n\\t}\\n\\n\\th1 {\\n\\t\\tfont-size: 2.8em;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tfont-weight: 700;\\n\\t\\tmargin: 0 0 0.5em 0;\\n\\t}\\n\\n\\tfigure {\\n\\t\\tmargin: 0 0 1em 0;\\n\\t}\\n\\n\\timg {\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: 400px;\\n\\t\\tmargin: 0 0 1em 0;\\n\\t}\\n\\n\\tp {\\n\\t\\tmargin: 1em auto;\\n\\t}\\n\\n\\t@media (min-width: 480px) {\\n\\t\\th1 {\\n\\t\\t\\tfont-size: 4em;\\n\\t\\t}\\n\\t}\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<svelte:head>\\n\\t<title>Sapper project template</title>\\n</svelte:head>\\n\\n<h1>Great success!</h1>\\n\\n<figure>\\n\\t<img alt='Borat' src='great-success.png'>\\n\\t<figcaption>HIGH FIVE!</figcaption>\\n</figure>\\n\\n<p><strong>Try editing this file (src/routes/index.svelte) to test live reloading.</strong></p>\\n\"],\"names\":[],\"mappings\":\"AACC,iBAAE,CAAE,qBAAM,CAAE,CAAC,eAAC,CAAC,AACd,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,CAAC,CAAC,IAAI,AACf,CAAC,AAED,EAAE,eAAC,CAAC,AACH,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACpB,CAAC,AAED,MAAM,eAAC,CAAC,AACP,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,AAClB,CAAC,AAED,GAAG,eAAC,CAAC,AACJ,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,AAClB,CAAC,AAED,CAAC,eAAC,CAAC,AACF,MAAM,CAAE,GAAG,CAAC,IAAI,AACjB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,EAAE,eAAC,CAAC,AACH,SAAS,CAAE,GAAG,AACf,CAAC,AACF,CAAC\"}"
};
...
<h1 class="${"svelte-13l94pn"}">Great success!</h1>

<figure class="${"svelte-13l94pn"}"><img alt="${"Borat"}" src="${"great-success.png"}" class="${"svelte-13l94pn"}">
	<figcaption>HIGH FIVE!</figcaption></figure>

<p class="${"svelte-13l94pn"}"><strong>Try editing this file (src/routes/index.svelte) to test live reloading.</strong></p>`;
});
...
const Truman = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div class="${"hero-head"}"><nav class="${"navbar is-transparent is-spaced"}"><div class="${"navbar-brand"}"><a class="${"navbar-item"}" href="${"base"}"><img alt="${"logomark"}" src="${"../wanderlust-white.svg"}" width="${"112"}" height="${"28"}"></a>
    ...
    <div class="${"navbar-end is-hidden-mobile"}"><div class="${"navbar-item"}"><div class="${"field is-grouped"}"><a class="${"navbar-item"}" href="${"travel"}">Morocco</a>
          <a class="${"navbar-item"}" href="${"istanbul"}">Istanbul</a>
          <a class="${"navbar-item"}" href="${"peru"}">Peru</a>
          <a class="${"navbar-item"}" href="${"russia"}">Russia</a></div></div></div></nav></div>`;
});
...
const css$1 = {
	...
	map: "{\"version\":3,\"file\":\"Hero.svelte\",\"sources\":[\"Hero.svelte\"],\"sourcesContent\":[\"<script>\\n  import Truman from '../components/Truman.svelte';\\n  import { destination } from '../routes/morocco.js';\\n  import { fade } from 'svelte/transition';\\n\\tlet visible = true;\\n</script>\\n\\n<style media=\\\"screen\\\" lang=\\\"scss\\\">h1 {\\n  font-family: 'Engagement', cursive;\\n  font-size: 8rem;\\n  text-align: center;\\n  color: white; }\\n\\n.hero {\\n  background: url(\\\"../images/morocco-thumb.jpg\\\");\\n  background-position: center;\\n  background-size: cover;\\n  background-color: #5876A3; }\\n\\n.image-gallery figure img {\\n  margin-bottom: 30px; }\\n/*# sourceMappingURL=src/components/Hero.svelte.map */</style>\\n\\n<section in:fade =\\\"{{ duration: 500 }}\\\" class=\\\"hero is-link is-fullheight\\\">\\n\\n\\t<Truman/>\\n\\n  <div class=\\\"hero-body\\\">\\n    <div class=\\\"container\\\">\\n      <h1 in:fade=\\\"{{ duration: 2000 }}\\\">{destination}</h1>\\n    </div>\\n  </div>\\n</section>\\n\"],\"names\":[],\"mappings\":\"AAOkC,EAAE,cAAC,CAAC,AACpC,WAAW,CAAE,YAAY,CAAC,CAAC,OAAO,CAClC,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,MAAM,CAClB,KAAK,CAAE,KAAK,AAAE,CAAC,AAEjB,KAAK,cAAC,CAAC,AACL,UAAU,CAAE,IAAI,6BAA6B,CAAC,CAC9C,mBAAmB,CAAE,MAAM,CAC3B,eAAe,CAAE,KAAK,CACtB,gBAAgB,CAAE,OAAO,AAAE,CAAC\"}"
};

const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$1);

	return `<section class="${"hero is-link is-fullheight svelte-zqtudu"}">${validate_component(Truman, "Truman").$$render($$result, {}, {}, {})}

  <div class="${"hero-body"}"><div class="${"container"}"><h1 class="${"svelte-zqtudu"}">${escape(destination)}</h1></div></div></section>`;
});
...
const css$4 = {
	code: "figure.svelte-o0jvfh img.svelte-o0jvfh{margin-bottom:30px}",
	map: "{\"version\":3,\"file\":\"travel.svelte\",\"sources\":[\"travel.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport Hero from '../components/Hero.svelte';\\n\\timport Blurb from '../components/Blurb.svelte';\\n\\timport ChapterHeader from '../components/ChapterHeader.svelte';\\n\\timport { fade } from 'svelte/transition';\\n\\timport { photosOne, photosTwo } from './morocco.js';\\n\\timport { destination, chapter } from './morocco.js';\\n\\tlet visible = true;\\n</script>\\n\\n<style media=\\\"screen\\\" lang=\\\"scss\\\">figure img {\\n  margin-bottom: 30px; }\\n/*# sourceMappingURL=src/routes/travel.svelte.map */</style>\\n\\n\\n<!-- Page starts -->\\n\\n<svelte:head>\\n\\t<title>{destination}</title>\\n</svelte:head>\\n\\n<Hero/>\\n\\n<Blurb/>\\n\\n\\t{#each photosOne as photo, i}\\n\\t\\t<div class=\\\"container image-gallery\\\">\\n\\t\\t\\t\\t<figure><img src={photo.src} alt={photo.alt}></figure>\\n\\t\\t</div>\\n\\t{/each}\\n\\n<ChapterHeader title={chapter.one}/>\\n\\n\\t{#each photosTwo as photo, i}\\n\\t\\t<div class=\\\"container image-gallery\\\">\\n\\t\\t\\t\\t<figure><img src={photo.src} alt={photo.alt}></figure>\\n\\t\\t</div>\\n\\t{/each}\\n\\n<ChapterHeader title={chapter.two}/>\\n\\n\\t{#each photosTwo as photo, i}\\n\\t\\t<div class=\\\"container image-gallery\\\">\\n\\t\\t\\t\\t<figure><img src={photo.src} alt={photo.alt}></figure>\\n\\t\\t</div>\\n\\t{/each}\\n\"],\"names\":[],\"mappings\":\"AAUkC,oBAAM,CAAC,GAAG,cAAC,CAAC,AAC5C,aAAa,CAAE,IAAI,AAAE,CAAC\"}"
};

const Travel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$4);

	return `

${($$result.head += `${($$result.title = `<title>${escape(destination)}</title>`, "")}`, "")}

${validate_component(Hero, "Hero").$$render($$result, {}, {}, {})}

${validate_component(Blurb, "Blurb").$$render($$result, {}, {}, {})}

	${each(photosOne, (photo, i) => `<div class="${"container image-gallery"}"><figure class="${"svelte-o0jvfh"}"><img${add_attribute("src", photo.src, 0)}${add_attribute("alt", photo.alt, 0)} class="${"svelte-o0jvfh"}"></figure>
		</div>`)}

${validate_component(ChapterHeader, "ChapterHeader").$$render($$result, { title: chapter.one }, {}, {})}

	${each(photosTwo, (photo, i) => `<div class="${"container image-gallery"}"><figure class="${"svelte-o0jvfh"}"><img${add_attribute("src", photo.src, 0)}${add_attribute("alt", photo.alt, 0)} class="${"svelte-o0jvfh"}"></figure>
		</div>`)}
...
const Base = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"hero is-success is-fullheight svelte-10nssdk"}">
  <div class="${"hero-head"}"><header class="${"navbar"}"><div class="${"container"}"><div class="${"navbar-brand is-hidden-tablet svelte-10nssdk"}"><a class="${"navbar-item svelte-10nssdk"}"><img src="${"wanderlust.svg"}" alt="${"logomark"}" width="${"112"}" height="${"28"}"></a>

          <span class="${"navbar-burger burger svelte-10nssdk"}" data-target="${"navbarMenuHeroC"}"><span></span>
            <span></span>
            <span></span></span></div></div></header>

    
        <div class="${["modal is-clipped", active ? "is-active" : ""].join(" ").trim()}"><div class="${"modal-background"}"></div>
          <div class="${"modal-content"}"><div class="${"container"}"><div class="${"columns has-text-centered"}"><div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-10nssdk"}">Morocco</a></div>
                  <div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-10nssdk"}">Istanbul</a></div>
                  <div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-10nssdk"}">Peru</a></div>
                  <div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-10nssdk"}">Russia</a></div></div></div>
              <button class="${"modal-close is-large"}" aria-label="${"close"}"></button></div></div></div>
  <input type="${"checkbox"}"${add_attribute("checked", active, 1)}>



  

  <div class="${"hero-image svelte-10nssdk"}"><div class="${"shoes hero-body svelte-10nssdk"}"><div class="${"container"}"><h1 class="${"svelte-10nssdk"}">Wanderlust</h1></div></div></div>

  
  <div class="${"hero-foot is-hidden-mobile svelte-10nssdk"}"><nav class="${"tabs is-fullwidth"}"><div class="${"container"}"><ul class="${"svelte-10nssdk"}"><li class="${"is-active"}"><a class="${"svelte-10nssdk"}">Home</a></li>
          <li><a href="${"travel"}" class="${"svelte-10nssdk"}">Morocco</a></li>
          <li><a href="${"travel"}" class="${"svelte-10nssdk"}">Istanbul</a></li>
          <li><a href="${"travel"}" class="${"svelte-10nssdk"}">Russia</a></li>
          <li><a href="${"travel"}" class="${"svelte-10nssdk"}">Peru</a></li></ul></div></nav></div></section>`;
});
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/travel\/?$/,
			parts: [
				{ name: "travel", file: "travel.svelte", component: Travel }
			]
		},

		{
			...
			pattern: /^\/base\/?$/,
			parts: [
				{ name: "base", file: "base.svelte", component: Base }
			]
		},
