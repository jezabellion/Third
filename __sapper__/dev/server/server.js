...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(current) + " hero is-transparent is-fullheight" + " svelte-c8b24w"}">${validate_component(TravelPageNav, "TravelPageNav").$$render($$result, {}, {}, {})}

    <div class="${"hero-body svelte-c8b24w"}"><div class="${"container"}"><h1 class="${"svelte-c8b24w"}">${escape(destHead)}</h1></div></div></section>`;
});
