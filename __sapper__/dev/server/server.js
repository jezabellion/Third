...
const css = {
	code: ".hero.svelte-1xhc3gr.svelte-1xhc3gr{background-color:white}h1.svelte-1xhc3gr.svelte-1xhc3gr{font-family:'Engagement';font-size:150px;color:#FFFFFF;letter-spacing:-6.25px;text-align:center;font-weight:normal;margin-top:auto}.hero-body.svelte-1xhc3gr.svelte-1xhc3gr{padding-top:8rem;padding-bottom:8rem}.hero-image.svelte-1xhc3gr.svelte-1xhc3gr{margin-left:8rem;margin-right:8rem}.shoes.svelte-1xhc3gr.svelte-1xhc3gr{background-image:url(\"../images/shoes.jpg\") !important;background-size:cover;background-position:center}.hero-foot.svelte-1xhc3gr.svelte-1xhc3gr{margin-bottom:2rem}.hero.svelte-1xhc3gr .tabs ul.svelte-1xhc3gr,.hero.svelte-1xhc3gr .hero-foot .tabs ul.svelte-1xhc3gr{padding-left:14rem;padding-right:14rem}.hero.svelte-1xhc3gr .hero-foot .tabs ul.svelte-1xhc3gr{padding-top:3rem}.hero-foot .hero-body.svelte-1xhc3gr h1.svelte-1xhc3gr{margin-top:auto}.hero.svelte-1xhc3gr .hero-foot .tabs a.svelte-1xhc3gr{color:black;font-size:1rem;font-weight:bold}.hero.svelte-1xhc3gr .hero-foot .tabs a.svelte-1xhc3gr:hover{color:grey}@media screen and (max-width: 768px){.hero-image.svelte-1xhc3gr.svelte-1xhc3gr{margin:auto 2rem}.navbar-brand.svelte-1xhc3gr.svelte-1xhc3gr{padding:1rem}.navbar-burger.svelte-1xhc3gr.svelte-1xhc3gr{color:black !important}.hero-body.svelte-1xhc3gr h1.svelte-1xhc3gr{visibility:hidden}.shoes.svelte-1xhc3gr.svelte-1xhc3gr{background-image:url(\"../images/shoes-portrait.jpg\") !important;background-size:cover;background-position:center;margin-left:1rem;margin-right:1rem}}",
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"hero is-success is-fullheight svelte-1xhc3gr"}">
  <div class="${"hero-head"}"><header class="${"navbar"}"><div class="${"container"}"><div class="${"navbar-brand is-hidden-tablet svelte-1xhc3gr"}"><a class="${"navbar-item svelte-1xhc3gr"}"><img src="${"wanderlust.svg"}" alt="${"logomark"}" width="${"112"}" height="${"28"}"></a>
          <span class="${"navbar-burger burger svelte-1xhc3gr"}" data-target="${"navbarMenuHeroC"}"><span></span>
            <span></span>
            <span></span></span></div></div></header>

    
        <div class="${["modal is-clipped", showModal ? "is-active" : ""].join(" ").trim()}"><div class="${"modal-background"}"></div>
          <div class="${"modal-content"}"><div class="${"container"}"><div class="${"columns has-text-centered"}"><div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-1xhc3gr"}">${escape(destination.one)}</a></div>
                  <div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-1xhc3gr"}">${escape(destination.two)}</a></div>
                  <div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-1xhc3gr"}">Peru</a></div>
                  <div class="${"column"}"><a href="${"pages/morocco.html"}" class="${"svelte-1xhc3gr"}">Russia</a></div></div></div>
              <button class="${"modal-close is-large"}" aria-label="${"close"}"></button></div></div></div>

  

  <div class="${"hero-image svelte-1xhc3gr"}"><div class="${"shoes hero-body svelte-1xhc3gr"}"><div class="${"container"}"><h1 class="${"svelte-1xhc3gr"}">Wanderlust</h1></div></div></div>

  
  <div class="${"hero-foot is-hidden-mobile svelte-1xhc3gr"}"><nav class="${"tabs is-fullwidth"}"><div class="${"container"}"><ul class="${"svelte-1xhc3gr"}">
          <li><a href="${"travel"}" class="${"svelte-1xhc3gr"}">${escape(destination.one)}</a></li>
          <li><a href="${"travel"}" class="${"svelte-1xhc3gr"}">${escape(destination.two)}</a></li>
          <li><a href="${"travel"}" class="${"svelte-1xhc3gr"}">Russia</a></li>
          <li><a href="${"travel"}" class="${"svelte-1xhc3gr"}">Peru</a></li></ul></div></nav></div></section>`;
});
