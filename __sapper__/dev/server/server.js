...
const css = {
	code: ".modal.svelte-4t6r7z.svelte-4t6r7z{margin:1rem}.modal-content.svelte-4t6r7z.svelte-4t6r7z{overflow:hidden}.modal.svelte-4t6r7z a.svelte-4t6r7z{font-size:1.25rem;color:white;font-family:'Lato', sans-serif;font-weight:bold}.modal.svelte-4t6r7z a.svelte-4t6r7z:hover{opacity:50%}",
	map: "{\"version\":3,\"file\":\"ModalNav.svelte\",\"sources\":[\"ModalNav.svelte\"],\"sourcesContent\":[\"<script>\\n  import { destination } from '../routes/morocco.js';\\n  export let showModal = false;\\n</script>\\n\\n<style>\\n  .modal {\\n    margin: 1rem;\\n  }\\n  .modal-content {\\n    overflow: hidden;\\n  }\\n  .modal a {\\n    font-size: 1.25rem;\\n    color: white;\\n    font-family: 'Lato', sans-serif;\\n    font-weight: bold;\\n  }\\n  .modal a:hover {\\n    opacity: 50%;\\n  }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n<div class:is-active={showModal} class=\\\"modal is-clipped\\\">\\n  <div class=\\\"modal-background\\\"></div>\\n  <div class=\\\"modal-content\\\">\\n    <div class=\\\"container\\\">\\n        <div class=\\\"columns has-text-centered\\\">\\n          <div class=\\\"column\\\">\\n            <a href=\\\"morocco\\\">{destination.one}</a>\\n          </div>\\n          <div class=\\\"column\\\">\\n            <a href=\\\"morocco\\\">{destination.two}</a>\\n          </div>\\n          <div class=\\\"column\\\">\\n            <a href=\\\"peru\\\">Peru</a>\\n          </div>\\n          <div class=\\\"column\\\">\\n            <a href=\\\"russia\\\">Russia</a>\\n          </div>\\n        </div>\\n      </div>\\n      <button on:click={() => showModal = false} class=\\\"modal-close is-large\\\" aria-label=\\\"close\\\"></button>\\n    </div>\\n  </div>\\n\"],\"names\":[],\"mappings\":\"AAME,MAAM,4BAAC,CAAC,AACN,MAAM,CAAE,IAAI,AACd,CAAC,AACD,cAAc,4BAAC,CAAC,AACd,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,oBAAM,CAAC,CAAC,cAAC,CAAC,AACR,SAAS,CAAE,OAAO,CAClB,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,MAAM,CAAC,CAAC,UAAU,CAC/B,WAAW,CAAE,IAAI,AACnB,CAAC,AACD,oBAAM,CAAC,eAAC,MAAM,AAAC,CAAC,AACd,OAAO,CAAE,GAAG,AACd,CAAC\"}"
};
...
const ModalNav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${["modal is-clipped svelte-4t6r7z", showModal ? "is-active" : ""].join(" ").trim()}"><div class="${"modal-background"}"></div>
  <div class="${"modal-content svelte-4t6r7z"}"><div class="${"container"}"><div class="${"columns has-text-centered"}"><div class="${"column"}"><a href="${"morocco"}" class="${"svelte-4t6r7z"}">${escape(destination.one)}</a></div>
          <div class="${"column"}"><a href="${"morocco"}" class="${"svelte-4t6r7z"}">${escape(destination.two)}</a></div>
          <div class="${"column"}"><a href="${"peru"}" class="${"svelte-4t6r7z"}">Peru</a></div>
          <div class="${"column"}"><a href="${"russia"}" class="${"svelte-4t6r7z"}">Russia</a></div></div></div>
...
<div class="${"hero-head"}"><nav class="${"navbar is-transparent is-spaced"}"><div class="${"navbar-brand svelte-1i7v3mi"}"><a class="${"navbar-item svelte-1i7v3mi"}" href="${"./"}"><img alt="${"logomark"}" src="${"../wanderlust-white.svg"}" width="${"112"}" height="${"28"}"></a>
      <a role="${"button"}" class="${"navbar-burger is-hidden-tablet svelte-1i7v3mi"}" aria-label="${"menu"}" aria-expanded="${"false"}"><span aria-hidden="${"true"}" class="${"svelte-1i7v3mi"}"></span>
        <span aria-hidden="${"true"}" class="${"svelte-1i7v3mi"}"></span>
        <span aria-hidden="${"true"}" class="${"svelte-1i7v3mi"}"></span></a></div>

    <div class="${"navbar-end is-hidden-mobile"}"><div class="${"navbar-item svelte-1i7v3mi"}"><div class="${"field is-grouped"}"><a class="${"navbar-item svelte-1i7v3mi"}" href="${"morocco"}">${escape(destination.one)}</a>
          <a class="${"navbar-item svelte-1i7v3mi"}" href="${"istanbul"}">${escape(destination.two)}</a>
          <a class="${"navbar-item svelte-1i7v3mi"}" href="${"peru"}">${escape(destination.three)}</a>
          <a class="${"navbar-item svelte-1i7v3mi"}" href="${"russia"}">${escape(destination.four)}</a></div></div></div></nav></div>`;
	} while (!$$settled);
...
const css$6 = {
	code: "h1.svelte-1y53tes.svelte-1y53tes{font-family:'Engagement';font-size:150px;color:#FFFFFF;letter-spacing:-6.25px;text-align:center;font-weight:normal;margin-top:auto}.hero-body.svelte-1y53tes.svelte-1y53tes{padding-top:8rem;padding-bottom:8rem}.hero-image.svelte-1y53tes.svelte-1y53tes{margin-left:8rem;margin-right:8rem}.shoes.svelte-1y53tes.svelte-1y53tes{background-image:url(\"../images/shoes.jpg\") !important;background-size:cover;background-position:center}.hero-foot.svelte-1y53tes.svelte-1y53tes{margin-bottom:2rem}.tabs.svelte-1y53tes ul.svelte-1y53tes,.hero-foot.svelte-1y53tes .tabs ul.svelte-1y53tes{padding-left:14rem;padding-right:14rem}.hero-foot.svelte-1y53tes .tabs ul.svelte-1y53tes{padding-top:3rem}.hero-foot .hero-body.svelte-1y53tes h1.svelte-1y53tes{margin-top:auto}button.svelte-1y53tes.svelte-1y53tes,.hero-foot.svelte-1y53tes .tabs a.svelte-1y53tes{color:black;font-size:1rem;font-weight:bold;font-family:'Lato', sans-serif;font-size:1rem}.hero-foot.svelte-1y53tes .tabs a.svelte-1y53tes:hover{color:grey}.tabs.svelte-1y53tes ul.svelte-1y53tes{border-bottom-color:transparent;border-bottom-style:none}nav.svelte-1y53tes.svelte-1y53tes,button.svelte-1y53tes.svelte-1y53tes{margin-bottom:4rem}button.svelte-1y53tes.svelte-1y53tes{margin-top:2rem}@media screen and (max-width: 768px){.hero-image.svelte-1y53tes.svelte-1y53tes{margin:auto 2rem}.hero-body.svelte-1y53tes h1.svelte-1y53tes{visibility:hidden}.shoes.svelte-1y53tes.svelte-1y53tes{background-image:url(\"../images/shoes-portrait.jpg\") !important;background-size:cover;background-position:center;margin-left:1rem;margin-right:1rem}}@media screen and (max-width: 1023px){.hero-body.svelte-1y53tes h1.svelte-1y53tes{font-size:6rem;letter-spacing:-4px}}",
	map: "{\"version\":3,\"file\":\"ShoeHero.svelte\",\"sources\":[\"ShoeHero.svelte\"],\"sourcesContent\":[\"<script >\\n  import { destination, chapter } from '../routes/morocco.js';\\n  import ModalNav from '../components/ModalNav.svelte';\\n  export let showModal = false;\\n</script>\\n\\n<style media=\\\"screen\\\" lang=\\\"scss\\\">.hero {\\n  background-color: white; }\\n\\nh1 {\\n  font-family: 'Engagement';\\n  font-size: 150px;\\n  color: #FFFFFF;\\n  letter-spacing: -6.25px;\\n  text-align: center;\\n  font-weight: normal;\\n  margin-top: auto; }\\n\\n.hero-body {\\n  padding-top: 8rem;\\n  padding-bottom: 8rem; }\\n\\n.hero-image {\\n  margin-left: 8rem;\\n  margin-right: 8rem; }\\n\\n.shoes,\\n.home-pic {\\n  background-image: url(\\\"../images/shoes.jpg\\\") !important;\\n  background-size: cover;\\n  background-position: center; }\\n\\n.hero-foot {\\n  margin-bottom: 2rem; }\\n\\n.tabs ul,\\n.hero-foot .tabs ul {\\n  padding-left: 14rem;\\n  padding-right: 14rem; }\\n\\n.hero-foot .tabs ul {\\n  padding-top: 3rem; }\\n\\n.hero-foot .hero-body h1 {\\n  margin-top: auto; }\\n\\nbutton,\\n.hero-foot .tabs a {\\n  color: black;\\n  font-size: 1rem;\\n  font-weight: bold;\\n  font-family: 'Lato', sans-serif;\\n  font-size: 1rem; }\\n\\n.hero-foot .tabs a:hover {\\n  color: grey; }\\n\\n.chapter-close h3 {\\n  color: grey;\\n  text-align: center;\\n  font-family: 'Engagement';\\n  font-size: 4rem;\\n  line-height: 4rem;\\n  margin: 10rem 5rem; }\\n\\n.tabs ul {\\n  border-bottom-color: transparent;\\n  border-bottom-style: none; }\\n\\nnav,\\nbutton {\\n  margin-bottom: 4rem; }\\n\\nbutton {\\n  margin-top: 2rem; }\\n\\n@media screen and (max-width: 768px) {\\n  .hero-image {\\n    margin: auto 2rem; }\\n  .navbar-brand {\\n    padding: 1rem; }\\n  .navbar-burger {\\n    color: black !important; }\\n  .hero-body h1 {\\n    visibility: hidden; }\\n  .shoes {\\n    background-image: url(\\\"../images/shoes-portrait.jpg\\\") !important;\\n    background-size: cover;\\n    background-position: center;\\n    margin-left: 1rem;\\n    margin-right: 1rem; } }\\n\\n@media screen and (max-width: 1023px) {\\n  .hero-body h1 {\\n    font-size: 6rem;\\n    letter-spacing: -4px; } }\\n/*# sourceMappingURL=src/components/ShoeHero.svelte.map */</style>\\n\\n<ModalNav bind:showModal/>\\n\\n<!-- <section class=\\\"hero is-fullheight\\\"> -->\\n  <!-- Hero head: will stick at the top -->\\n  <!-- <div class=\\\"hero-head\\\">\\n    <header class=\\\"navbar\\\">\\n      <div class=\\\"container\\\">\\n        <div class=\\\"navbar-brand is-hidden-tablet\\\">\\n          <a class=\\\"navbar-item\\\" href='./'>\\n            <img src=\\\"wanderlust.svg\\\" alt='logomark' width=\\\"112\\\" height=\\\"28\\\">\\n          </a>\\n          <span on:click={() => showModal = true} class=\\\"navbar-burger burger\\\" data-target=\\\"navbarMenuHeroC\\\">\\n            <span></span>\\n            <span></span>\\n            <span></span>\\n          </span>\\n\\n        </div>\\n\\n       </div>\\n     </header>\\n   </div> -->\\n\\n  <!-- Hero content: will be in the middle -->\\n\\n  <div class=\\\"hero-image\\\">\\n    <div class=\\\"shoes hero-body\\\">\\n      <div class=\\\"container\\\">\\n        <h1>Wanderlust</h1>\\n      </div>\\n    </div>\\n  </div>\\n\\n  <!-- Hero footer: will stick at the bottom -->\\n  <div class=\\\"hero-foot is-hidden-mobile\\\">\\n    <nav class=\\\"tabs is-fullwidth\\\">\\n      <div class=\\\"container\\\">\\n        <ul>\\n          <!-- <li class=\\\"is-active\\\"><a>Home</a></li> -->\\n          <li><a href=\\\"morocco\\\">{destination.one}</a></li>\\n          <li><a href=\\\"travel\\\">{destination.two}</a></li>\\n          <li><a href=\\\"travel\\\">{destination.three}</a></li>\\n          <li><a href=\\\"travel\\\">{destination.four}</a></li>\\n        </ul>\\n      </div>\\n    </nav>\\n  </div>\\n\\n<!-- </section> -->\\n<div class=\\\"container is-hidden-tablet\\\">\\n  <div class=\\\"column has-text-centered\\\">\\n    <button class=\\\"button is-white\\\" on:click={() => showModal = true}>Menu</button>\\n  </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AASA,EAAE,8BAAC,CAAC,AACF,WAAW,CAAE,YAAY,CACzB,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,OAAO,CACvB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,IAAI,AAAE,CAAC,AAErB,UAAU,8BAAC,CAAC,AACV,WAAW,CAAE,IAAI,CACjB,cAAc,CAAE,IAAI,AAAE,CAAC,AAEzB,WAAW,8BAAC,CAAC,AACX,WAAW,CAAE,IAAI,CACjB,YAAY,CAAE,IAAI,AAAE,CAAC,AAEvB,MAAM,8BACI,CAAC,AACT,gBAAgB,CAAE,IAAI,qBAAqB,CAAC,CAAC,UAAU,CACvD,eAAe,CAAE,KAAK,CACtB,mBAAmB,CAAE,MAAM,AAAE,CAAC,AAEhC,UAAU,8BAAC,CAAC,AACV,aAAa,CAAE,IAAI,AAAE,CAAC,AAExB,oBAAK,CAAC,iBAAE,CACR,yBAAU,CAAC,KAAK,CAAC,EAAE,eAAC,CAAC,AACnB,YAAY,CAAE,KAAK,CACnB,aAAa,CAAE,KAAK,AAAE,CAAC,AAEzB,yBAAU,CAAC,KAAK,CAAC,EAAE,eAAC,CAAC,AACnB,WAAW,CAAE,IAAI,AAAE,CAAC,AAEtB,UAAU,CAAC,yBAAU,CAAC,EAAE,eAAC,CAAC,AACxB,UAAU,CAAE,IAAI,AAAE,CAAC,AAErB,oCAAM,CACN,yBAAU,CAAC,KAAK,CAAC,CAAC,eAAC,CAAC,AAClB,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,MAAM,CAAC,CAAC,UAAU,CAC/B,SAAS,CAAE,IAAI,AAAE,CAAC,AAEpB,yBAAU,CAAC,KAAK,CAAC,gBAAC,MAAM,AAAC,CAAC,AACxB,KAAK,CAAE,IAAI,AAAE,CAAC,AAUhB,oBAAK,CAAC,EAAE,eAAC,CAAC,AACR,mBAAmB,CAAE,WAAW,CAChC,mBAAmB,CAAE,IAAI,AAAE,CAAC,AAE9B,iCAAG,CACH,MAAM,8BAAC,CAAC,AACN,aAAa,CAAE,IAAI,AAAE,CAAC,AAExB,MAAM,8BAAC,CAAC,AACN,UAAU,CAAE,IAAI,AAAE,CAAC,AAErB,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,WAAW,8BAAC,CAAC,AACX,MAAM,CAAE,IAAI,CAAC,IAAI,AAAE,CAAC,AAKtB,yBAAU,CAAC,EAAE,eAAC,CAAC,AACb,UAAU,CAAE,MAAM,AAAE,CAAC,AACvB,MAAM,8BAAC,CAAC,AACN,gBAAgB,CAAE,IAAI,8BAA8B,CAAC,CAAC,UAAU,CAChE,eAAe,CAAE,KAAK,CACtB,mBAAmB,CAAE,MAAM,CAC3B,WAAW,CAAE,IAAI,CACjB,YAAY,CAAE,IAAI,AAAE,CAAC,AAAC,CAAC,AAE3B,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,yBAAU,CAAC,EAAE,eAAC,CAAC,AACb,SAAS,CAAE,IAAI,CACf,cAAc,CAAE,IAAI,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const ShoeHero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"hero-image svelte-1y53tes"}"><div class="${"shoes hero-body svelte-1y53tes"}"><div class="${"container"}"><h1 class="${"svelte-1y53tes"}">Wanderlust</h1></div></div></div>

  
  <div class="${"hero-foot is-hidden-mobile svelte-1y53tes"}"><nav class="${"tabs is-fullwidth svelte-1y53tes"}"><div class="${"container"}"><ul class="${"svelte-1y53tes"}">
          <li><a href="${"morocco"}" class="${"svelte-1y53tes"}">${escape(destination.one)}</a></li>
          <li><a href="${"travel"}" class="${"svelte-1y53tes"}">${escape(destination.two)}</a></li>
          <li><a href="${"travel"}" class="${"svelte-1y53tes"}">${escape(destination.three)}</a></li>
          <li><a href="${"travel"}" class="${"svelte-1y53tes"}">${escape(destination.four)}</a></li></ul></div></nav></div>


<div class="${"container is-hidden-tablet"}"><div class="${"column has-text-centered"}"><button class="${"button is-white svelte-1y53tes"}">Menu</button></div></div>`;
	} while (!$$settled);
